...
#define TRANSPORT_SOCKET_OPTION_IP_ADD_MEMBERSHIP ((uint64_t)1 << 12)         // TODO: Support
#define TRANSPORT_SOCKET_OPTION_IP_ADD_SOURCE_MEMBERSHIP ((uint64_t)1 << 13)  // TODO: Support
#define TRANSPORT_SOCKET_OPTION_IP_DROP_MEMBERSHIP ((uint64_t)1 << 14)        // TODO: Support
#define TRANSPORT_SOCKET_OPTION_IP_DROP_SOURCE_MEMBERSHIP ((uint64_t)1 << 15) // TODO: Support
