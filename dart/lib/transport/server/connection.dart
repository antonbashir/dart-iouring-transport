...
class TransportServerConnection {
  ...
  void listenBySingle(void Function(TransportPayload payload) listener, {void Function(dynamic error)? onError}) async {
  ...
  void listenByMany(int count, void Function(TransportPayload payload) listener, {void Function(dynamic error)? onError}) async {
    while (!_server.closing && _server.connectionIsActive(_channel.fd)) {
