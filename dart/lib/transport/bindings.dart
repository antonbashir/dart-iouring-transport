...
late final _ssignalPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int )>> Function(ffi.Int , ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int )>> )>>('ssignal');
...
late final ffi.Pointer<ffi.Pointer<ffi.Pointer<ffi.Char>>> _sys_siglist = _lookup<ffi.Pointer<ffi.Pointer<ffi.Char>>>('sys_siglist');
...
late final _atomic_flag_test_and_setPtr = _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<atomic_flag> )>>('atomic_flag_test_and_set');
late final _atomic_flag_test_and_set = _atomic_flag_test_and_setPtr.asFunction<bool Function(ffi.Pointer<atomic_flag> )>();
...
late final _atomic_flag_test_and_set_explicitPtr = _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<atomic_flag> , ffi.Int32 )>>('atomic_flag_test_and_set_explicit');
late final _atomic_flag_test_and_set_explicit = _atomic_flag_test_and_set_explicitPtr.asFunction<bool Function(ffi.Pointer<atomic_flag> , int )>();
...
late final _atomic_flag_clearPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<atomic_flag> )>>('atomic_flag_clear');
late final _atomic_flag_clear = _atomic_flag_clearPtr.asFunction<void Function(ffi.Pointer<atomic_flag> )>();
...
late final _atomic_flag_clear_explicitPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<atomic_flag> , ffi.Int32 )>>('atomic_flag_clear_explicit');
late final _atomic_flag_clear_explicit = _atomic_flag_clear_explicitPtr.asFunction<void Function(ffi.Pointer<atomic_flag> , int )>();
...
late final _ibuf_createPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ibuf> , ffi.Pointer<slab_cache> , ffi.Size )>>('ibuf_create');
late final _ibuf_create = _ibuf_createPtr.asFunction<void Function(ffi.Pointer<ibuf> , ffi.Pointer<slab_cache> , int )>();
...
late final _ibuf_destroyPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ibuf> )>>('ibuf_destroy');
late final _ibuf_destroy = _ibuf_destroyPtr.asFunction<void Function(ffi.Pointer<ibuf> )>();
...
late final _ibuf_reinitPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ibuf> )>>('ibuf_reinit');
late final _ibuf_reinit = _ibuf_reinitPtr.asFunction<void Function(ffi.Pointer<ibuf> )>();
...
late final _ibuf_reserve_slowPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ibuf> , ffi.Size )>>('ibuf_reserve_slow');
late final _ibuf_reserve_slow = _ibuf_reserve_slowPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ibuf> , int )>();
...
late final _obuf_createPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<obuf> , ffi.Pointer<slab_cache> , ffi.Size )>>('obuf_create');
late final _obuf_create = _obuf_createPtr.asFunction<void Function(ffi.Pointer<obuf> , ffi.Pointer<slab_cache> , int )>();
...
late final _obuf_destroyPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<obuf> )>>('obuf_destroy');
late final _obuf_destroy = _obuf_destroyPtr.asFunction<void Function(ffi.Pointer<obuf> )>();
...
late final _obuf_resetPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<obuf> )>>('obuf_reset');
late final _obuf_reset = _obuf_resetPtr.asFunction<void Function(ffi.Pointer<obuf> )>();
...
late final _obuf_reserve_slowPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<obuf> , ffi.Size )>>('obuf_reserve_slow');
late final _obuf_reserve_slow = _obuf_reserve_slowPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<obuf> , int )>();
...
late final _obuf_dupPtr = _lookup<ffi.NativeFunction<ffi.Size Function(ffi.Pointer<obuf> , ffi.Pointer<ffi.Void> , ffi.Size )>>('obuf_dup');
late final _obuf_dup = _obuf_dupPtr.asFunction<int Function(ffi.Pointer<obuf> , ffi.Pointer<ffi.Void> , int )>();
...
late final _obuf_rollback_to_svpPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<obuf> , ffi.Pointer<obuf_svp> )>>('obuf_rollback_to_svp');
late final _obuf_rollback_to_svp = _obuf_rollback_to_svpPtr.asFunction<void Function(ffi.Pointer<obuf> , ffi.Pointer<obuf_svp> )>();
...
late final _on_exitPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int , ffi.Pointer<ffi.Void> )>> , ffi.Pointer<ffi.Void> )>>('on_exit');
late final _on_exit = _on_exitPtr.asFunction<int Function(ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int , ffi.Pointer<ffi.Void> )>> , ffi.Pointer<ffi.Void> )>();
...
late final _mmapPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int , ffi.Int , ffi.Int , ffi.Long )>>('mmap');
late final _mmap = _mmapPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> , int , int , int , int , int )>();
...
late final _mprotectPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int )>>('mprotect');
late final _mprotect = _mprotectPtr.asFunction<int Function(ffi.Pointer<ffi.Void> , int , int )>();
...
late final _msyncPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int )>>('msync');
late final _msync = _msyncPtr.asFunction<int Function(ffi.Pointer<ffi.Void> , int , int )>();
...
late final _madvisePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int )>>('madvise');
late final _madvise = _madvisePtr.asFunction<int Function(ffi.Pointer<ffi.Void> , int , int )>();
...
late final _posix_madvisePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int )>>('posix_madvise');
late final _posix_madvise = _posix_madvisePtr.asFunction<int Function(ffi.Pointer<ffi.Void> , int , int )>();
...
late final _mlockPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size )>>('mlock');
late final _mlock = _mlockPtr.asFunction<int Function(ffi.Pointer<ffi.Void> , int )>();
...
late final _munlockPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size )>>('munlock');
late final _munlock = _munlockPtr.asFunction<int Function(ffi.Pointer<ffi.Void> , int )>();
...
late final _mlockallPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int )>>('mlockall');
...
late final _munlockallPtr = _lookup<ffi.NativeFunction<ffi.Int Function()>>('munlockall');
...
late final _mincorePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Pointer<ffi.UnsignedChar> )>>('mincore');
late final _mincore = _mincorePtr.asFunction<int Function(ffi.Pointer<ffi.Void> , int , ffi.Pointer<ffi.UnsignedChar> )>();
...
late final _shm_openPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> , ffi.Int , mode_t )>>('shm_open');
late final _shm_open = _shm_openPtr.asFunction<int Function(ffi.Pointer<ffi.Char> , int , int )>();
...
late final _shm_unlinkPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> )>>('shm_unlink');
late final _shm_unlink = _shm_unlinkPtr.asFunction<int Function(ffi.Pointer<ffi.Char> )>();
...
late final _slab_arena_createPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<slab_arena> , ffi.Pointer<quota> , ffi.Size , ffi.Uint32 , ffi.Int )>>('slab_arena_create');
late final _slab_arena_create = _slab_arena_createPtr.asFunction<int Function(ffi.Pointer<slab_arena> , ffi.Pointer<quota> , int , int , int )>();
...
late final _slab_arena_destroyPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_arena> )>>('slab_arena_destroy');
late final _slab_arena_destroy = _slab_arena_destroyPtr.asFunction<void Function(ffi.Pointer<slab_arena> )>();
...
late final _slab_mapPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<slab_arena> )>>('slab_map');
late final _slab_map = _slab_mapPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<slab_arena> )>();
...
late final _slab_unmapPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_arena> , ffi.Pointer<ffi.Void> )>>('slab_unmap');
late final _slab_unmap = _slab_unmapPtr.asFunction<void Function(ffi.Pointer<slab_arena> , ffi.Pointer<ffi.Void> )>();
...
late final _slab_arena_mprotectPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_arena> )>>('slab_arena_mprotect');
late final _slab_arena_mprotect = _slab_arena_mprotectPtr.asFunction<void Function(ffi.Pointer<slab_arena> )>();
...
late final _pthread_join = _pthread_joinPtr.asFunction<int Function(int , ffi.Pointer<ffi.Pointer<ffi.Void>> )>();
...
late final _pthread_detach = _pthread_detachPtr.asFunction<int Function(int )>();
...
late final _pthread_equal = _pthread_equalPtr.asFunction<int Function(int , int )>();
...
late final _pthread_setschedparam = _pthread_setschedparamPtr.asFunction<int Function(int , int , ffi.Pointer<sched_param> )>();
...
late final _pthread_getschedparam = _pthread_getschedparamPtr.asFunction<int Function(int , ffi.Pointer<ffi.Int> , ffi.Pointer<sched_param> )>();
...
late final _pthread_setschedprioPtr = _lookup<ffi.NativeFunction<ffi.Int Function(pthread_t , ffi.Int )>>('pthread_setschedprio');
late final _pthread_setschedprio = _pthread_setschedprioPtr.asFunction<int Function(int , int )>();
...
late final _pthread_cancel = _pthread_cancelPtr.asFunction<int Function(int )>();
...
late final _pthread_mutex_timedlockPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> , ffi.Pointer<timespec> )>>('pthread_mutex_timedlock');
late final _pthread_mutex_timedlock = _pthread_mutex_timedlockPtr.asFunction<int Function(ffi.Pointer<pthread_mutex_t> , ffi.Pointer<timespec> )>();
...
late final _pthread_mutex_consistentPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> )>>('pthread_mutex_consistent');
late final _pthread_mutex_consistent = _pthread_mutex_consistentPtr.asFunction<int Function(ffi.Pointer<pthread_mutex_t> )>();
...
late final _pthread_mutexattr_getrobustPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Pointer<ffi.Int> )>>('pthread_mutexattr_getrobust');
late final _pthread_mutexattr_getrobust = _pthread_mutexattr_getrobustPtr.asFunction<int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Pointer<ffi.Int> )>();
...
late final _pthread_mutexattr_setrobustPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Int )>>('pthread_mutexattr_setrobust');
late final _pthread_mutexattr_setrobust = _pthread_mutexattr_setrobustPtr.asFunction<int Function(ffi.Pointer<pthread_mutexattr_t> , int )>();
...
late final _pthread_rwlock_timedrdlockPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> , ffi.Pointer<timespec> )>>('pthread_rwlock_timedrdlock');
late final _pthread_rwlock_timedrdlock = _pthread_rwlock_timedrdlockPtr.asFunction<int Function(ffi.Pointer<pthread_rwlock_t> , ffi.Pointer<timespec> )>();
...
late final _pthread_rwlock_timedwrlockPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> , ffi.Pointer<timespec> )>>('pthread_rwlock_timedwrlock');
late final _pthread_rwlock_timedwrlock = _pthread_rwlock_timedwrlockPtr.asFunction<int Function(ffi.Pointer<pthread_rwlock_t> , ffi.Pointer<timespec> )>();
...
late final _pthread_rwlockattr_getkind_npPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlockattr_t> , ffi.Pointer<ffi.Int> )>>('pthread_rwlockattr_getkind_np');
late final _pthread_rwlockattr_getkind_np = _pthread_rwlockattr_getkind_npPtr.asFunction<int Function(ffi.Pointer<pthread_rwlockattr_t> , ffi.Pointer<ffi.Int> )>();
...
late final _pthread_rwlockattr_setkind_npPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlockattr_t> , ffi.Int )>>('pthread_rwlockattr_setkind_np');
late final _pthread_rwlockattr_setkind_np = _pthread_rwlockattr_setkind_npPtr.asFunction<int Function(ffi.Pointer<pthread_rwlockattr_t> , int )>();
...
late final _pthread_condattr_getclockPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_condattr_t> , ffi.Pointer<ffi.Int> )>>('pthread_condattr_getclock');
late final _pthread_condattr_getclock = _pthread_condattr_getclockPtr.asFunction<int Function(ffi.Pointer<pthread_condattr_t> , ffi.Pointer<ffi.Int> )>();
...
late final _pthread_condattr_setclockPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_condattr_t> , ffi.Int )>>('pthread_condattr_setclock');
late final _pthread_condattr_setclock = _pthread_condattr_setclockPtr.asFunction<int Function(ffi.Pointer<pthread_condattr_t> , int )>();
...
late final _pthread_barrier_initPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrier_t> , ffi.Pointer<pthread_barrierattr_t> , ffi.UnsignedInt )>>('pthread_barrier_init');
late final _pthread_barrier_init = _pthread_barrier_initPtr.asFunction<int Function(ffi.Pointer<pthread_barrier_t> , ffi.Pointer<pthread_barrierattr_t> , int )>();
...
late final _pthread_barrier_destroyPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrier_t> )>>('pthread_barrier_destroy');
late final _pthread_barrier_destroy = _pthread_barrier_destroyPtr.asFunction<int Function(ffi.Pointer<pthread_barrier_t> )>();
...
late final _pthread_barrier_waitPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrier_t> )>>('pthread_barrier_wait');
late final _pthread_barrier_wait = _pthread_barrier_waitPtr.asFunction<int Function(ffi.Pointer<pthread_barrier_t> )>();
...
late final _pthread_barrierattr_initPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrierattr_t> )>>('pthread_barrierattr_init');
late final _pthread_barrierattr_init = _pthread_barrierattr_initPtr.asFunction<int Function(ffi.Pointer<pthread_barrierattr_t> )>();
...
late final _pthread_barrierattr_destroyPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrierattr_t> )>>('pthread_barrierattr_destroy');
late final _pthread_barrierattr_destroy = _pthread_barrierattr_destroyPtr.asFunction<int Function(ffi.Pointer<pthread_barrierattr_t> )>();
...
late final _pthread_barrierattr_getpsharedPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrierattr_t> , ffi.Pointer<ffi.Int> )>>('pthread_barrierattr_getpshared');
late final _pthread_barrierattr_getpshared = _pthread_barrierattr_getpsharedPtr.asFunction<int Function(ffi.Pointer<pthread_barrierattr_t> , ffi.Pointer<ffi.Int> )>();
...
late final _pthread_barrierattr_setpsharedPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrierattr_t> , ffi.Int )>>('pthread_barrierattr_setpshared');
late final _pthread_barrierattr_setpshared = _pthread_barrierattr_setpsharedPtr.asFunction<int Function(ffi.Pointer<pthread_barrierattr_t> , int )>();
...
late final _pthread_getcpuclockidPtr = _lookup<ffi.NativeFunction<ffi.Int Function(pthread_t , ffi.Pointer<ffi.Int> )>>('pthread_getcpuclockid');
late final _pthread_getcpuclockid = _pthread_getcpuclockidPtr.asFunction<int Function(int , ffi.Pointer<ffi.Int> )>();
...
late final ffi.Pointer<ffi.Uint32> _slab_magic = _lookup<ffi.Uint32>('slab_magic');
...
late final _slab_cache_createPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab_arena> )>>('slab_cache_create');
late final _slab_cache_create = _slab_cache_createPtr.asFunction<void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab_arena> )>();
...
late final _slab_cache_destroyPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> )>>('slab_cache_destroy');
late final _slab_cache_destroy = _slab_cache_destroyPtr.asFunction<void Function(ffi.Pointer<slab_cache> )>();
...
late final _slab_get_with_orderPtr = _lookup<ffi.NativeFunction<ffi.Pointer<slab> Function(ffi.Pointer<slab_cache> , ffi.Uint8 )>>('slab_get_with_order');
late final _slab_get_with_order = _slab_get_with_orderPtr.asFunction<ffi.Pointer<slab> Function(ffi.Pointer<slab_cache> , int )>();
...
late final _slab_put_with_orderPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab> )>>('slab_put_with_order');
late final _slab_put_with_order = _slab_put_with_orderPtr.asFunction<void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab> )>();
...
late final _slab_get_largePtr = _lookup<ffi.NativeFunction<ffi.Pointer<slab> Function(ffi.Pointer<slab_cache> , ffi.Size )>>('slab_get_large');
late final _slab_get_large = _slab_get_largePtr.asFunction<ffi.Pointer<slab> Function(ffi.Pointer<slab_cache> , int )>();
...
late final _slab_put_largePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab> )>>('slab_put_large');
late final _slab_put_large = _slab_put_largePtr.asFunction<void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab> )>();
...
late final _slab_getPtr = _lookup<ffi.NativeFunction<ffi.Pointer<slab> Function(ffi.Pointer<slab_cache> , ffi.Size )>>('slab_get');
late final _slab_get = _slab_getPtr.asFunction<ffi.Pointer<slab> Function(ffi.Pointer<slab_cache> , int )>();
...
late final _slab_putPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab> )>>('slab_put');
late final _slab_put = _slab_putPtr.asFunction<void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab> )>();
...
late final _slab_cache_checkPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> )>>('slab_cache_check');
late final _slab_cache_check = _slab_cache_checkPtr.asFunction<void Function(ffi.Pointer<slab_cache> )>();

/// Mempool will try to allocate blocks large enough to ensure
/// the overhead from internal fragmentation is less than the
/// specified below.
late final ffi.Pointer<ffi.Double> _OVERHEAD_RATIO = _lookup<ffi.Double>('OVERHEAD_RATIO');
...
late final _mempool_stats1Ptr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mempool> , ffi.Pointer<mempool_stats> )>>('mempool_stats');
late final _mempool_stats1 = _mempool_stats1Ptr.asFunction<void Function(ffi.Pointer<mempool> , ffi.Pointer<mempool_stats> )>();
...
late final _mempool_create_with_orderPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mempool> , ffi.Pointer<slab_cache> , ffi.Uint32 , ffi.Uint8 )>>('mempool_create_with_order');
late final _mempool_create_with_order = _mempool_create_with_orderPtr.asFunction<void Function(ffi.Pointer<mempool> , ffi.Pointer<slab_cache> , int , int )>();
...
late final _mempool_destroyPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mempool> )>>('mempool_destroy');
late final _mempool_destroy = _mempool_destroyPtr.asFunction<void Function(ffi.Pointer<mempool> )>();
...
late final _mempool_allocPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<mempool> )>>('mempool_alloc');
late final _mempool_alloc = _mempool_allocPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<mempool> )>();
...
late final _mslab_freePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mempool> , ffi.Pointer<mslab> , ffi.Pointer<ffi.Void> )>>('mslab_free');
late final _mslab_free = _mslab_freePtr.asFunction<void Function(ffi.Pointer<mempool> , ffi.Pointer<mslab> , ffi.Pointer<ffi.Void> )>();
...
late final _small_class_createPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_class> , ffi.UnsignedInt , ffi.Float , ffi.UnsignedInt , ffi.Pointer<ffi.Float> )>>('small_class_create');
late final _small_class_create = _small_class_createPtr.asFunction<void Function(ffi.Pointer<small_class> , int , double , int , ffi.Pointer<ffi.Float> )>();
...
late final _small_alloc_createPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Pointer<slab_cache> , ffi.Uint32 , ffi.UnsignedInt , ffi.Float , ffi.Pointer<ffi.Float> )>>('small_alloc_create');
late final _small_alloc_create = _small_alloc_createPtr.asFunction<void Function(ffi.Pointer<small_alloc> , ffi.Pointer<slab_cache> , int , int , double , ffi.Pointer<ffi.Float> )>();
...
late final _small_alloc_setoptPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Int32 , ffi.Bool )>>('small_alloc_setopt');
late final _small_alloc_setopt = _small_alloc_setoptPtr.asFunction<void Function(ffi.Pointer<small_alloc> , int , bool )>();
...
late final _small_alloc_destroyPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> )>>('small_alloc_destroy');
late final _small_alloc_destroy = _small_alloc_destroyPtr.asFunction<void Function(ffi.Pointer<small_alloc> )>();
...
late final _smallocPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<small_alloc> , ffi.Size )>>('smalloc');
late final _smalloc = _smallocPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<small_alloc> , int )>();
...
late final _smfreePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Pointer<ffi.Void> , ffi.Size )>>('smfree');
late final _smfree = _smfreePtr.asFunction<void Function(ffi.Pointer<small_alloc> , ffi.Pointer<ffi.Void> , int )>();
...
late final _smfree_delayedPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Pointer<ffi.Void> , ffi.Size )>>('smfree_delayed');
late final _smfree_delayed = _smfree_delayedPtr.asFunction<void Function(ffi.Pointer<small_alloc> , ffi.Pointer<ffi.Void> , int )>();
...
late final _small_ptr_compressPtr = _lookup<ffi.NativeFunction<ffi.Size Function(ffi.Pointer<small_alloc> , ffi.Pointer<ffi.Void> )>>('small_ptr_compress');
late final _small_ptr_compress = _small_ptr_compressPtr.asFunction<int Function(ffi.Pointer<small_alloc> , ffi.Pointer<ffi.Void> )>();
...
late final _small_ptr_decompressPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<small_alloc> , ffi.Size )>>('small_ptr_decompress');
late final _small_ptr_decompress = _small_ptr_decompressPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<small_alloc> , int )>();
...
late final _small_stats1Ptr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Pointer<small_stats> , mempool_stats_cb , ffi.Pointer<ffi.Void> )>>('small_stats');
late final _small_stats1 = _small_stats1Ptr.asFunction<void Function(ffi.Pointer<small_alloc> , ffi.Pointer<small_stats> , mempool_stats_cb , ffi.Pointer<ffi.Void> )>();
...
late final _Dart_UpdateExternalSizePtr = _lookup<ffi.NativeFunction<ffi.Void Function(Dart_WeakPersistentHandle , ffi.IntPtr )>>('Dart_UpdateExternalSize');
late final _Dart_UpdateExternalSize = _Dart_UpdateExternalSizePtr.asFunction<void Function(Dart_WeakPersistentHandle , int )>();
...
late final _Dart_UpdateFinalizableExternalSizePtr = _lookup<ffi.NativeFunction<ffi.Void Function(Dart_FinalizableHandle , ffi.Handle , ffi.IntPtr )>>('Dart_UpdateFinalizableExternalSize');
late final _Dart_UpdateFinalizableExternalSize = _Dart_UpdateFinalizableExternalSizePtr.asFunction<void Function(Dart_FinalizableHandle , Object , int )>();
...
late final _Dart_CreateIsolateGroupPtr = _lookup<ffi.NativeFunction<Dart_Isolate Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.Pointer<ffi.Uint8> , ffi.Pointer<Dart_IsolateFlags> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Pointer<ffi.Char>> )>>('Dart_CreateIsolateGroup');
late final _Dart_CreateIsolateGroup = _Dart_CreateIsolateGroupPtr.asFunction<Dart_Isolate Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.Pointer<ffi.Uint8> , ffi.Pointer<Dart_IsolateFlags> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Pointer<ffi.Char>> )>();
...
late final _Dart_CreateIsolateGroupFromKernelPtr = _lookup<ffi.NativeFunction<Dart_Isolate Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.IntPtr , ffi.Pointer<Dart_IsolateFlags> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Pointer<ffi.Char>> )>>('Dart_CreateIsolateGroupFromKernel');
late final _Dart_CreateIsolateGroupFromKernel = _Dart_CreateIsolateGroupFromKernelPtr.asFunction<Dart_Isolate Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , int , ffi.Pointer<Dart_IsolateFlags> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Pointer<ffi.Char>> )>();
...
late final _Dart_NotifyDetachPtr = _lookup<ffi.NativeFunction<ffi.Void Function()>>('Dart_NotifyDetach');
late final _Dart_NotifyDetach = _Dart_NotifyDetachPtr.asFunction<void Function()>();
...
late final _Dart_SetPerformanceModePtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Int32 )>>('Dart_SetPerformanceMode');
...
late final _Dart_NewListOfPtr = _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.IntPtr )>>('Dart_NewListOf');
...
late final _Dart_GetTypeOfTypedDataPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Handle )>>('Dart_GetTypeOfTypedData');
...
late final _Dart_GetTypeOfExternalTypedDataPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Handle )>>('Dart_GetTypeOfExternalTypedData');
...
late final _Dart_NewTypedDataPtr = _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.IntPtr )>>('Dart_NewTypedData');
...
late final _Dart_NewExternalTypedDataPtr = _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.Pointer<ffi.Void> , ffi.IntPtr )>>('Dart_NewExternalTypedData');
...
late final _Dart_NewExternalTypedDataWithFinalizerPtr = _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.Pointer<ffi.Void> , ffi.IntPtr , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>>('Dart_NewExternalTypedDataWithFinalizer');
...
late final _Dart_NewUnmodifiableExternalTypedDataWithFinalizerPtr = _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.Pointer<ffi.Void> , ffi.IntPtr , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>>('Dart_NewUnmodifiableExternalTypedDataWithFinalizer');
...
late final _Dart_TypedDataAcquireDataPtr = _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Int32> , ffi.Pointer<ffi.Pointer<ffi.Void>> , ffi.Pointer<ffi.IntPtr> )>>('Dart_TypedDataAcquireData');
late final _Dart_TypedDataAcquireData = _Dart_TypedDataAcquireDataPtr.asFunction<Object Function(Object , ffi.Pointer<ffi.Int32> , ffi.Pointer<ffi.Pointer<ffi.Void>> , ffi.Pointer<ffi.IntPtr> )>();
...
late final _Dart_CompileToKernelPtr = _lookup<ffi.NativeFunction<Dart_KernelCompilationResult Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.IntPtr , ffi.Bool , ffi.Bool , ffi.Pointer<ffi.Char> , ffi.Int32 )>>('Dart_CompileToKernel');
late final _Dart_CompileToKernel = _Dart_CompileToKernelPtr.asFunction<Dart_KernelCompilationResult Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , int , bool , bool , ffi.Pointer<ffi.Char> , int )>();
...
late final _Dart_CompileToKernelWithGivenNullsafetyPtr = _lookup<ffi.NativeFunction<Dart_KernelCompilationResult Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.IntPtr , ffi.Bool , ffi.Pointer<ffi.Char> , ffi.Bool , ffi.Int32 )>>('Dart_CompileToKernelWithGivenNullsafety');
late final _Dart_CompileToKernelWithGivenNullsafety = _Dart_CompileToKernelWithGivenNullsafetyPtr.asFunction<Dart_KernelCompilationResult Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , int , bool , ffi.Pointer<ffi.Char> , bool , int )>();
...
late final _Dart_CreateCoreJITSnapshotAsBlobsPtr = _lookup<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> )>>('Dart_CreateCoreJITSnapshotAsBlobs');
late final _Dart_CreateCoreJITSnapshotAsBlobs = _Dart_CreateCoreJITSnapshotAsBlobsPtr.asFunction<Object Function(ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> )>();
...
int transport_listener_initialize(
...
late final _transport_listener_initializePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_listener_t> , ffi.Pointer<transport_listener_configuration_t> , ffi.Uint8 )>>('transport_listener_initialize');
late final _transport_listener_initialize = _transport_listener_initializePtr.asFunction<int Function(ffi.Pointer<transport_listener_t> , ffi.Pointer<transport_listener_configuration_t> , int )>();
...
late final _transport_listener_closePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_listener_t> )>>('transport_listener_close');
late final _transport_listener_close = _transport_listener_closePtr.asFunction<void Function(ffi.Pointer<transport_listener_t> )>();
...
late final _transport_listener_reapPtr = _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<transport_listener_t> , ffi.Pointer<ffi.Pointer<io_uring_cqe>> )>>('transport_listener_reap');
late final _transport_listener_reap = _transport_listener_reapPtr.asFunction<bool Function(ffi.Pointer<transport_listener_t> , ffi.Pointer<ffi.Pointer<io_uring_cqe>> )>();
...
late final _transport_listener_destroyPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_listener_t> )>>('transport_listener_destroy');
late final _transport_listener_destroy = _transport_listener_destroyPtr.asFunction<void Function(ffi.Pointer<transport_listener_t> )>();
...
late final _transport_server_initialize_tcpPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Int32 )>>('transport_server_initialize_tcp');
late final _transport_server_initialize_tcp = _transport_server_initialize_tcpPtr.asFunction<int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> , int )>();
...
late final _transport_server_initialize_udpPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Int32 )>>('transport_server_initialize_udp');
late final _transport_server_initialize_udp = _transport_server_initialize_udpPtr.asFunction<int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> , int )>();
...
late final _transport_server_initialize_unix_streamPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> )>>('transport_server_initialize_unix_stream');
late final _transport_server_initialize_unix_stream = _transport_server_initialize_unix_streamPtr.asFunction<int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> )>();
...
late final _transport_server_initialize_unix_dgramPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> )>>('transport_server_initialize_unix_dgram');
late final _transport_server_initialize_unix_dgram = _transport_server_initialize_unix_dgramPtr.asFunction<int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> )>();
...
late final _strindexPtr = _lookup<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<ffi.Pointer<ffi.Char>> , ffi.Pointer<ffi.Char> , ffi.Uint32 )>>('strindex');
late final _strindex = _strindexPtr.asFunction<int Function(ffi.Pointer<ffi.Pointer<ffi.Char>> , ffi.Pointer<ffi.Char> , int )>();
...
late final _strnindexPtr = _lookup<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<ffi.Pointer<ffi.Char>> , ffi.Pointer<ffi.Char> , ffi.Uint32 , ffi.Uint32 )>>('strnindex');
late final _strnindex = _strnindexPtr.asFunction<int Function(ffi.Pointer<ffi.Pointer<ffi.Char>> , ffi.Pointer<ffi.Char> , int , int )>();
...
late final _close_all_xcptPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int )>>('close_all_xcpt');
late final _close_all_xcpt = _close_all_xcptPtr.asFunction<void Function(int )>();
...
late final _fdprintfPtr = _lookup<ffi.NativeFunction<ssize_t Function(ffi.Int , ffi.Pointer<ffi.Char> )>>('fdprintf');
late final _fdprintf = _fdprintfPtr.asFunction<int Function(int , ffi.Pointer<ffi.Char> )>();
...
late final _find_pathPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> )>>('find_path');
late final _find_path = _find_pathPtr.asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> )>();
...
late final _abspathPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> )>>('abspath');
late final _abspath = _abspathPtr.asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> )>();
...
late final _mkdirpathPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> )>>('mkdirpath');
late final _mkdirpath = _mkdirpathPtr.asFunction<int Function(ffi.Pointer<ffi.Char> )>();
...
late final _int2strPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.LongLong )>>('int2str');
late final _int2str = _int2strPtr.asFunction<ffi.Pointer<ffi.Char> Function(int )>();
...
late final _fpconv_checkPtr = _lookup<ffi.NativeFunction<ffi.Void Function()>>('fpconv_check');
late final _fpconv_check = _fpconv_checkPtr.asFunction<void Function()>();

late final ffi.Pointer<ffi.Pointer<ffi.Pointer<ffi.Char>>> _precision_fmts = _lookup<ffi.Pointer<ffi.Pointer<ffi.Char>>>('precision_fmts');

ffi.Pointer<ffi.Pointer<ffi.Char>> get precision_fmts => _precision_fmts.value;

set precision_fmts(ffi.Pointer<ffi.Pointer<ffi.Char>> value) => _precision_fmts.value = value;
...
late final _utf8_check_printablePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> , ffi.Size )>>('utf8_check_printable');
late final _utf8_check_printable = _utf8_check_printablePtr.asFunction<int Function(ffi.Pointer<ffi.Char> , int )>();
...
late final _memrchrPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> , ffi.Int , ffi.Size )>>('memrchr');
late final _memrchr = _memrchrPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> , int , int )>();
...
late final _json_escapePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> , ffi.Int , ffi.Pointer<ffi.Char> )>>('json_escape');
late final _json_escape = _json_escapePtr.asFunction<int Function(ffi.Pointer<ffi.Char> , int , ffi.Pointer<ffi.Char> )>();
...
late final _double_compare_uint64Ptr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Double , ffi.Uint64 , ffi.Int )>>('double_compare_uint64');
late final _double_compare_uint64 = _double_compare_uint64Ptr.asFunction<int Function(double , int , int )>();
...
late final _double_compare_nint64Ptr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Double , ffi.Int64 , ffi.Int )>>('double_compare_nint64');
late final _double_compare_nint64 = _double_compare_nint64Ptr.asFunction<int Function(double , int , int )>();
...
late final _thread_sleepPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Double )>>('thread_sleep');
late final _thread_sleep = _thread_sleepPtr.asFunction<void Function(double )>();
...
late final _getenv_safePtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Size )>>('getenv_safe');
late final _getenv_safe = _getenv_safePtr.asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , int )>();
...
late final _transport_listener_pool_initializePtr = _lookup<ffi.NativeFunction<ffi.Pointer<transport_listener_pool_t> Function()>>('transport_listener_pool_initialize');
late final _transport_listener_pool_initialize = _transport_listener_pool_initializePtr.asFunction<ffi.Pointer<transport_listener_pool_t> Function()>();
...
late final _transport_listener_pool_addPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_listener_pool_t> , ffi.Pointer<transport_listener_t> )>>('transport_listener_pool_add');
late final _transport_listener_pool_add = _transport_listener_pool_addPtr.asFunction<void Function(ffi.Pointer<transport_listener_pool_t> , ffi.Pointer<transport_listener_t> )>();
...
late final _transport_listener_pool_removePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_listener_pool_t> , ffi.Pointer<transport_listener_t> )>>('transport_listener_pool_remove');
late final _transport_listener_pool_remove = _transport_listener_pool_removePtr.asFunction<void Function(ffi.Pointer<transport_listener_pool_t> , ffi.Pointer<transport_listener_t> )>();
...
late final _transport_client_initialize_tcpPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Int32 )>>('transport_client_initialize_tcp');
late final _transport_client_initialize_tcp = _transport_client_initialize_tcpPtr.asFunction<int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> , int )>();
...
late final _transport_client_initialize_udpPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Int32 , ffi.Pointer<ffi.Char> , ffi.Int32 )>>('transport_client_initialize_udp');
late final _transport_client_initialize_udp = _transport_client_initialize_udpPtr.asFunction<int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> , int , ffi.Pointer<ffi.Char> , int )>();
...
late final _transport_client_initialize_unix_streamPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> )>>('transport_client_initialize_unix_stream');
late final _transport_client_initialize_unix_stream = _transport_client_initialize_unix_streamPtr.asFunction<int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> )>();
...
late final _transport_client_initialize_unix_dgramPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('transport_client_initialize_unix_dgram');
late final _transport_client_initialize_unix_dgram = _transport_client_initialize_unix_dgramPtr.asFunction<int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();
...
late final _mh_i32_newPtr = _lookup<ffi.NativeFunction<ffi.Pointer<mh_i32_t> Function()>>('mh_i32_new');
late final _mh_i32_new = _mh_i32_newPtr.asFunction<ffi.Pointer<mh_i32_t> Function()>();
...
late final _mh_i32_clearPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> )>>('mh_i32_clear');
late final _mh_i32_clear = _mh_i32_clearPtr.asFunction<void Function(ffi.Pointer<mh_i32_t> )>();
...
late final _mh_i32_deletePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> )>>('mh_i32_delete');
late final _mh_i32_delete = _mh_i32_deletePtr.asFunction<void Function(ffi.Pointer<mh_i32_t> )>();
...
late final _mh_i32_resizePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> , ffi.Int32 )>>('mh_i32_resize');
late final _mh_i32_resize = _mh_i32_resizePtr.asFunction<void Function(ffi.Pointer<mh_i32_t> , int )>();
...
late final _mh_i32_start_resizePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mh_i32_t> , mh_int_t , mh_int_t , ffi.Int32 )>>('mh_i32_start_resize');
late final _mh_i32_start_resize = _mh_i32_start_resizePtr.asFunction<int Function(ffi.Pointer<mh_i32_t> , int , int , int )>();
...
late final _mh_i32_reservePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mh_i32_t> , mh_int_t , ffi.Int32 )>>('mh_i32_reserve');
late final _mh_i32_reserve = _mh_i32_reservePtr.asFunction<int Function(ffi.Pointer<mh_i32_t> , int , int )>();
...
late final _mh_i32_del_resizePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> , mh_int_t , ffi.Int32 )>>('mh_i32_del_resize');
late final _mh_i32_del_resize = _mh_i32_del_resizePtr.asFunction<void Function(ffi.Pointer<mh_i32_t> , int , int )>();
...
late final _mh_i32_memsizePtr = _lookup<ffi.NativeFunction<ffi.Size Function(ffi.Pointer<mh_i32_t> )>>('mh_i32_memsize');
late final _mh_i32_memsize = _mh_i32_memsizePtr.asFunction<int Function(ffi.Pointer<mh_i32_t> )>();
...
late final _mh_i32_dumpPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> )>>('mh_i32_dump');
late final _mh_i32_dump = _mh_i32_dumpPtr.asFunction<void Function(ffi.Pointer<mh_i32_t> )>();
...
late final _transport_worker_initializePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_worker_t> , ffi.Pointer<transport_worker_configuration_t> , ffi.Uint8 )>>('transport_worker_initialize');
late final _transport_worker_initialize = _transport_worker_initializePtr.asFunction<int Function(ffi.Pointer<transport_worker_t> , ffi.Pointer<transport_worker_configuration_t> , int )>();
...
late final _transport_worker_customPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint32 )>>('transport_worker_custom');
late final _transport_worker_custom = _transport_worker_customPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int , int )>();
...
late final _transport_worker_add_writePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint16 , ffi.Uint32 , ffi.Int64 , ffi.Uint16 , ffi.Uint8 )>>('transport_worker_add_write');
late final _transport_worker_add_write = _transport_worker_add_writePtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int , int , int , int , int , int )>();
...
late final _transport_worker_add_readPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint16 , ffi.Uint32 , ffi.Int64 , ffi.Uint16 , ffi.Uint8 , ffi.Uint16 )>>('transport_worker_add_read');
late final _transport_worker_add_read = _transport_worker_add_readPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int , int , int , int , int , int , int )>();
...
late final _transport_worker_add_send_messagePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint16 , ffi.Pointer<sockaddr> , ffi.Int32 , ffi.Int , ffi.Int64 , ffi.Uint16 , ffi.Uint8 , ffi.Uint16 )>>('transport_worker_add_send_message');
late final _transport_worker_add_send_message = _transport_worker_add_send_messagePtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int , int , ffi.Pointer<sockaddr> , int , int , int , int , int , int )>();
...
late final _transport_worker_add_receive_messagePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint16 , ffi.Int32 , ffi.Int , ffi.Int64 , ffi.Uint16 , ffi.Uint8 )>>('transport_worker_add_receive_message');
late final _transport_worker_add_receive_message = _transport_worker_add_receive_messagePtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int , int , int , int , int , int , int )>();
...
late final _transport_worker_connect = _transport_worker_connectPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , ffi.Pointer<transport_client_t> , int )>();
...
late final _transport_worker_accept = _transport_worker_acceptPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , ffi.Pointer<transport_server_t> )>();
...
late final _transport_worker_submitPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> )>>('transport_worker_submit');
late final _transport_worker_submit = _transport_worker_submitPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> )>();
...
late final _transport_worker_cancel_by_fd = _transport_worker_cancel_by_fdPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int )>();
...
late final _transport_worker_check_event_timeouts = _transport_worker_check_event_timeoutsPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> )>();
...
late final _transport_worker_remove_event = _transport_worker_remove_eventPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int )>();
...
late final _transport_worker_get_buffer = _transport_worker_get_bufferPtr.asFunction<int Function(ffi.Pointer<transport_worker_t> )>();
...
late final _transport_worker_release_buffer = _transport_worker_release_bufferPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int )>();
...
late final _transport_worker_get_sequencePtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<transport_worker_t> )>>('transport_worker_get_sequence');
late final _transport_worker_get_sequence = _transport_worker_get_sequencePtr.asFunction<int Function(ffi.Pointer<transport_worker_t> )>();
...
late final _transport_worker_release_sequencePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 )>>('transport_worker_release_sequence');
late final _transport_worker_release_sequence = _transport_worker_release_sequencePtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int )>();

ffi.Pointer<transport_worker_sequence_element_t> transport_worker_sequence_get_last_element(
  ffi.Pointer<transport_worker_t> worker,
  int sequence_id,
) {
...
late final _transport_worker_sequence_get_last_elementPtr = _lookup<ffi.NativeFunction<ffi.Pointer<transport_worker_sequence_element_t> Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 )>>('transport_worker_sequence_get_last_element');
late final _transport_worker_sequence_get_last_element = _transport_worker_sequence_get_last_elementPtr.asFunction<ffi.Pointer<transport_worker_sequence_element_t> Function(ffi.Pointer<transport_worker_t> , int )>();

ffi.Pointer<transport_worker_sequence_element_t> transport_worker_sequence_get_first_element(
  ffi.Pointer<transport_worker_t> worker,
  int sequence_id,
) {
...
late final _transport_worker_sequence_get_first_elementPtr = _lookup<ffi.NativeFunction<ffi.Pointer<transport_worker_sequence_element_t> Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 )>>('transport_worker_sequence_get_first_element');
late final _transport_worker_sequence_get_first_element = _transport_worker_sequence_get_first_elementPtr.asFunction<ffi.Pointer<transport_worker_sequence_element_t> Function(ffi.Pointer<transport_worker_t> , int )>();

ffi.Pointer<transport_worker_sequence_element_t> transport_worker_sequence_get_next_element(
  ffi.Pointer<transport_worker_t> worker,
  int sequence_id,
...
late final _transport_worker_sequence_get_next_elementPtr = _lookup<ffi.NativeFunction<ffi.Pointer<transport_worker_sequence_element_t> Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 , ffi.Pointer<transport_worker_sequence_element_t> )>>('transport_worker_sequence_get_next_element');
late final _transport_worker_sequence_get_next_element = _transport_worker_sequence_get_next_elementPtr.asFunction<ffi.Pointer<transport_worker_sequence_element_t> Function(ffi.Pointer<transport_worker_t> , int , ffi.Pointer<transport_worker_sequence_element_t> )>();

void transport_worker_sequence_delete_element(
  ffi.Pointer<transport_worker_t> worker,
  int sequence_id,
  ffi.Pointer<transport_worker_sequence_element_t> element,
) {
return _transport_worker_sequence_delete_element(
    worker,
    sequence_id,
    element,
  );
}
late final _transport_worker_sequence_delete_elementPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 , ffi.Pointer<transport_worker_sequence_element_t> )>>('transport_worker_sequence_delete_element');
late final _transport_worker_sequence_delete_element = _transport_worker_sequence_delete_elementPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int , ffi.Pointer<transport_worker_sequence_element_t> )>();
...
late final _transport_worker_sequence_release_elementPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 , ffi.Pointer<transport_worker_sequence_element_t> )>>('transport_worker_sequence_release_element');
late final _transport_worker_sequence_release_element = _transport_worker_sequence_release_elementPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> , int , ffi.Pointer<transport_worker_sequence_element_t> )>();
...
late final _transport_worker_get_datagram_addressPtr = _lookup<ffi.NativeFunction<ffi.Pointer<sockaddr> Function(ffi.Pointer<transport_worker_t> , ffi.Int32 , ffi.Int )>>('transport_worker_get_datagram_address');
late final _transport_worker_get_datagram_address = _transport_worker_get_datagram_addressPtr.asFunction<ffi.Pointer<sockaddr> Function(ffi.Pointer<transport_worker_t> , int , int )>();
...
late final _transport_worker_peekPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Uint32 , ffi.Pointer<ffi.Pointer<io_uring_cqe>> , ffi.Pointer<io_uring> )>>('transport_worker_peek');
late final _transport_worker_peek = _transport_worker_peekPtr.asFunction<int Function(int , ffi.Pointer<ffi.Pointer<io_uring_cqe>> , ffi.Pointer<io_uring> )>();
...
late final _transport_worker_destroy = _transport_worker_destroyPtr.asFunction<void Function(ffi.Pointer<transport_worker_t> )>();
...
late final _transport_initializePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_t> , ffi.Pointer<transport_listener_configuration_t> , ffi.Pointer<transport_worker_configuration_t> , ffi.Pointer<transport_worker_configuration_t> )>>('transport_initialize');
late final _transport_initialize = _transport_initializePtr.asFunction<void Function(ffi.Pointer<transport_t> , ffi.Pointer<transport_listener_configuration_t> , ffi.Pointer<transport_worker_configuration_t> , ffi.Pointer<transport_worker_configuration_t> )>();
...
late final _transport_allocate_cqesPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Pointer<io_uring_cqe>> Function(ffi.Uint32 )>>('transport_allocate_cqes');
late final _transport_allocate_cqes = _transport_allocate_cqesPtr.asFunction<ffi.Pointer<ffi.Pointer<io_uring_cqe>> Function(int )>();
...
late final _transport_destroyPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_t> )>>('transport_destroy');
late final _transport_destroy = _transport_destroyPtr.asFunction<void Function(ffi.Pointer<transport_t> )>();
...
late final _transport_close_descritorPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int )>>('transport_close_descritor');
late final _transport_close_descritor = _transport_close_descritorPtr.asFunction<void Function(int )>();
...
late final _transport_file_openPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> )>>('transport_file_open');
late final _transport_file_open = _transport_file_openPtr.asFunction<int Function(ffi.Pointer<ffi.Char> )>();
...
late final _transport_socket_create_tcpPtr = _lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Uint64 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint16 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint16 )>>('transport_socket_create_tcp');
...
late final _transport_socket_create_udpPtr = _lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Uint64 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint16 , ffi.Pointer<ip_mreqn> , ffi.Uint32 )>>('transport_socket_create_udp');
...
late final _transport_socket_create_unix_streamPtr = _lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Uint64 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 )>>('transport_socket_create_unix_stream');
...
late final _transport_socket_create_unix_dgramPtr = _lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Uint64 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 )>>('transport_socket_create_unix_dgram');
late final _transport_socket_create_unix_dgram = _transport_socket_create_unix_dgramPtr.asFunction<int Function(int , int , int , int , int )>();
...
late final _transport_socket_multicast_create_requestPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ip_mreqn> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Int )>>('transport_socket_multicast_create_request');
late final _transport_socket_multicast_create_request = _transport_socket_multicast_create_requestPtr.asFunction<ffi.Pointer<ip_mreqn> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , int )>();
...
late final _transport_socket_multicast_add_membershipPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Int )>>('transport_socket_multicast_add_membership');
...
late final _transport_socket_multicast_drop_membershipPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Int )>>('transport_socket_multicast_drop_membership');
...
late final _transport_socket_multicast_add_source_membershipPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('transport_socket_multicast_add_source_membership');
late final _transport_socket_multicast_add_source_membership = _transport_socket_multicast_add_source_membershipPtr.asFunction<int Function(int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();
...
late final _transport_socket_multicast_drop_source_membershipPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('transport_socket_multicast_drop_source_membership');
late final _transport_socket_multicast_drop_source_membership = _transport_socket_multicast_drop_source_membershipPtr.asFunction<int Function(int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();
...
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<fd_set> , ffi.Pointer<fd_set> , ffi.Pointer<fd_set> , ffi.Pointer<timespec> , ffi.Pointer<__sigset_t> )>> get pselect => _library._pselectPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int )>> Function(ffi.Int , ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int )>> )>> get signal => _library._signalPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int )>> Function(ffi.Int , ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int )>> )>> get ssignal => _library._ssignalPtr;
...
ffi.Pointer<ffi.Pointer<ffi.Pointer<ffi.Char>>> get sys_siglist => _library._sys_siglist;
...
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<atomic_flag> )>> get atomic_flag_test_and_set => _library._atomic_flag_test_and_setPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<atomic_flag> , ffi.Int32 )>> get atomic_flag_test_and_set_explicit => _library._atomic_flag_test_and_set_explicitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<atomic_flag> )>> get atomic_flag_clear => _library._atomic_flag_clearPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<atomic_flag> , ffi.Int32 )>> get atomic_flag_clear_explicit => _library._atomic_flag_clear_explicitPtr;
...
ffi.Pointer<ffi.Pointer<ffi.Pointer<ffi.Char>>> get sys_errlist => _library._sys_errlist;
...
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ibuf> , ffi.Pointer<slab_cache> , ffi.Size )>> get ibuf_create => _library._ibuf_createPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ibuf> )>> get ibuf_destroy => _library._ibuf_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ibuf> )>> get ibuf_reinit => _library._ibuf_reinitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ibuf> , ffi.Size )>> get ibuf_reserve_slow => _library._ibuf_reserve_slowPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<obuf> , ffi.Pointer<slab_cache> , ffi.Size )>> get obuf_create => _library._obuf_createPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<obuf> )>> get obuf_destroy => _library._obuf_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<obuf> )>> get obuf_reset => _library._obuf_resetPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<obuf> , ffi.Size )>> get obuf_reserve_slow => _library._obuf_reserve_slowPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Size Function(ffi.Pointer<obuf> , ffi.Pointer<ffi.Void> , ffi.Size )>> get obuf_dup => _library._obuf_dupPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<obuf> , ffi.Pointer<obuf_svp> )>> get obuf_rollback_to_svp => _library._obuf_rollback_to_svpPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int , ffi.Pointer<ffi.Void> )>> , ffi.Pointer<ffi.Void> )>> get on_exit => _library._on_exitPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> , ffi.Size , ffi.Size , ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> )>> )>> get bsearch => _library._bsearchPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Size , ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> )>> )>> get qsort => _library._qsortPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int , ffi.Int , ffi.Int , ffi.Long )>> get mmap => _library._mmapPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size )>> get munmap => _library._munmapPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int )>> get mprotect => _library._mprotectPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int )>> get msync => _library._msyncPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int )>> get madvise => _library._madvisePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Int )>> get posix_madvise => _library._posix_madvisePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size )>> get mlock => _library._mlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size )>> get munlock => _library._munlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Int )>> get mlockall => _library._mlockallPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function()>> get munlockall => _library._munlockallPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> , ffi.Size , ffi.Pointer<ffi.UnsignedChar> )>> get mincore => _library._mincorePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> , ffi.Int , mode_t )>> get shm_open => _library._shm_openPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> )>> get shm_unlink => _library._shm_unlinkPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<slab_arena> , ffi.Pointer<quota> , ffi.Size , ffi.Uint32 , ffi.Int )>> get slab_arena_create => _library._slab_arena_createPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_arena> )>> get slab_arena_destroy => _library._slab_arena_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<slab_arena> )>> get slab_map => _library._slab_mapPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_arena> , ffi.Pointer<ffi.Void> )>> get slab_unmap => _library._slab_unmapPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_arena> )>> get slab_arena_mprotect => _library._slab_arena_mprotectPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_t> , ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> )>> , ffi.Pointer<ffi.Void> )>> get pthread_create => _library._pthread_createPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>> get pthread_exit => _library._pthread_exitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_t , ffi.Pointer<ffi.Pointer<ffi.Void>> )>> get pthread_join => _library._pthread_joinPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_t )>> get pthread_detach => _library._pthread_detachPtr;
ffi.Pointer<ffi.NativeFunction<pthread_t Function()>> get pthread_self => _library._pthread_selfPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_t , pthread_t )>> get pthread_equal => _library._pthread_equalPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> )>> get pthread_attr_init => _library._pthread_attr_initPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> )>> get pthread_attr_destroy => _library._pthread_attr_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Int> )>> get pthread_attr_getdetachstate => _library._pthread_attr_getdetachstatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Int )>> get pthread_attr_setdetachstate => _library._pthread_attr_setdetachstatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Size> )>> get pthread_attr_getguardsize => _library._pthread_attr_getguardsizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Size )>> get pthread_attr_setguardsize => _library._pthread_attr_setguardsizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<sched_param> )>> get pthread_attr_getschedparam => _library._pthread_attr_getschedparamPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<sched_param> )>> get pthread_attr_setschedparam => _library._pthread_attr_setschedparamPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Int> )>> get pthread_attr_getschedpolicy => _library._pthread_attr_getschedpolicyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Int )>> get pthread_attr_setschedpolicy => _library._pthread_attr_setschedpolicyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Int> )>> get pthread_attr_getinheritsched => _library._pthread_attr_getinheritschedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Int )>> get pthread_attr_setinheritsched => _library._pthread_attr_setinheritschedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Int> )>> get pthread_attr_getscope => _library._pthread_attr_getscopePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Int )>> get pthread_attr_setscope => _library._pthread_attr_setscopePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Pointer<ffi.Void>> )>> get pthread_attr_getstackaddr => _library._pthread_attr_getstackaddrPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Void> )>> get pthread_attr_setstackaddr => _library._pthread_attr_setstackaddrPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Size> )>> get pthread_attr_getstacksize => _library._pthread_attr_getstacksizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Size )>> get pthread_attr_setstacksize => _library._pthread_attr_setstacksizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Pointer<ffi.Void>> , ffi.Pointer<ffi.Size> )>> get pthread_attr_getstack => _library._pthread_attr_getstackPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_attr_t> , ffi.Pointer<ffi.Void> , ffi.Size )>> get pthread_attr_setstack => _library._pthread_attr_setstackPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_t , ffi.Int , ffi.Pointer<sched_param> )>> get pthread_setschedparam => _library._pthread_setschedparamPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_t , ffi.Pointer<ffi.Int> , ffi.Pointer<sched_param> )>> get pthread_getschedparam => _library._pthread_getschedparamPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_t , ffi.Int )>> get pthread_setschedprio => _library._pthread_setschedprioPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_once_t> , ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> )>> get pthread_once => _library._pthread_oncePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Int> )>> get pthread_setcancelstate => _library._pthread_setcancelstatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Int> )>> get pthread_setcanceltype => _library._pthread_setcanceltypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_t )>> get pthread_cancel => _library._pthread_cancelPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get pthread_testcancel => _library._pthread_testcancelPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> , ffi.Pointer<pthread_mutexattr_t> )>> get pthread_mutex_init => _library._pthread_mutex_initPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> )>> get pthread_mutex_destroy => _library._pthread_mutex_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> )>> get pthread_mutex_trylock => _library._pthread_mutex_trylockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> )>> get pthread_mutex_lock => _library._pthread_mutex_lockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> , ffi.Pointer<timespec> )>> get pthread_mutex_timedlock => _library._pthread_mutex_timedlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> )>> get pthread_mutex_unlock => _library._pthread_mutex_unlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> , ffi.Pointer<ffi.Int> )>> get pthread_mutex_getprioceiling => _library._pthread_mutex_getprioceilingPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> , ffi.Int , ffi.Pointer<ffi.Int> )>> get pthread_mutex_setprioceiling => _library._pthread_mutex_setprioceilingPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutex_t> )>> get pthread_mutex_consistent => _library._pthread_mutex_consistentPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> )>> get pthread_mutexattr_init => _library._pthread_mutexattr_initPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> )>> get pthread_mutexattr_destroy => _library._pthread_mutexattr_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_mutexattr_getpshared => _library._pthread_mutexattr_getpsharedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Int )>> get pthread_mutexattr_setpshared => _library._pthread_mutexattr_setpsharedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_mutexattr_gettype => _library._pthread_mutexattr_gettypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Int )>> get pthread_mutexattr_settype => _library._pthread_mutexattr_settypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_mutexattr_getprotocol => _library._pthread_mutexattr_getprotocolPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Int )>> get pthread_mutexattr_setprotocol => _library._pthread_mutexattr_setprotocolPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_mutexattr_getprioceiling => _library._pthread_mutexattr_getprioceilingPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Int )>> get pthread_mutexattr_setprioceiling => _library._pthread_mutexattr_setprioceilingPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_mutexattr_getrobust => _library._pthread_mutexattr_getrobustPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_mutexattr_t> , ffi.Int )>> get pthread_mutexattr_setrobust => _library._pthread_mutexattr_setrobustPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> , ffi.Pointer<pthread_rwlockattr_t> )>> get pthread_rwlock_init => _library._pthread_rwlock_initPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> )>> get pthread_rwlock_destroy => _library._pthread_rwlock_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> )>> get pthread_rwlock_rdlock => _library._pthread_rwlock_rdlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> )>> get pthread_rwlock_tryrdlock => _library._pthread_rwlock_tryrdlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> , ffi.Pointer<timespec> )>> get pthread_rwlock_timedrdlock => _library._pthread_rwlock_timedrdlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> )>> get pthread_rwlock_wrlock => _library._pthread_rwlock_wrlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> )>> get pthread_rwlock_trywrlock => _library._pthread_rwlock_trywrlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> , ffi.Pointer<timespec> )>> get pthread_rwlock_timedwrlock => _library._pthread_rwlock_timedwrlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlock_t> )>> get pthread_rwlock_unlock => _library._pthread_rwlock_unlockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlockattr_t> )>> get pthread_rwlockattr_init => _library._pthread_rwlockattr_initPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlockattr_t> )>> get pthread_rwlockattr_destroy => _library._pthread_rwlockattr_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlockattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_rwlockattr_getpshared => _library._pthread_rwlockattr_getpsharedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlockattr_t> , ffi.Int )>> get pthread_rwlockattr_setpshared => _library._pthread_rwlockattr_setpsharedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlockattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_rwlockattr_getkind_np => _library._pthread_rwlockattr_getkind_npPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_rwlockattr_t> , ffi.Int )>> get pthread_rwlockattr_setkind_np => _library._pthread_rwlockattr_setkind_npPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_cond_t> , ffi.Pointer<pthread_condattr_t> )>> get pthread_cond_init => _library._pthread_cond_initPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_cond_t> )>> get pthread_cond_destroy => _library._pthread_cond_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_cond_t> )>> get pthread_cond_signal => _library._pthread_cond_signalPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_cond_t> )>> get pthread_cond_broadcast => _library._pthread_cond_broadcastPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_cond_t> , ffi.Pointer<pthread_mutex_t> )>> get pthread_cond_wait => _library._pthread_cond_waitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_cond_t> , ffi.Pointer<pthread_mutex_t> , ffi.Pointer<timespec> )>> get pthread_cond_timedwait => _library._pthread_cond_timedwaitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_condattr_t> )>> get pthread_condattr_init => _library._pthread_condattr_initPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_condattr_t> )>> get pthread_condattr_destroy => _library._pthread_condattr_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_condattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_condattr_getpshared => _library._pthread_condattr_getpsharedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_condattr_t> , ffi.Int )>> get pthread_condattr_setpshared => _library._pthread_condattr_setpsharedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_condattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_condattr_getclock => _library._pthread_condattr_getclockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_condattr_t> , ffi.Int )>> get pthread_condattr_setclock => _library._pthread_condattr_setclockPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrier_t> , ffi.Pointer<pthread_barrierattr_t> , ffi.UnsignedInt )>> get pthread_barrier_init => _library._pthread_barrier_initPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrier_t> )>> get pthread_barrier_destroy => _library._pthread_barrier_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrier_t> )>> get pthread_barrier_wait => _library._pthread_barrier_waitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrierattr_t> )>> get pthread_barrierattr_init => _library._pthread_barrierattr_initPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrierattr_t> )>> get pthread_barrierattr_destroy => _library._pthread_barrierattr_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrierattr_t> , ffi.Pointer<ffi.Int> )>> get pthread_barrierattr_getpshared => _library._pthread_barrierattr_getpsharedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_barrierattr_t> , ffi.Int )>> get pthread_barrierattr_setpshared => _library._pthread_barrierattr_setpsharedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<pthread_key_t> , ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>> )>> get pthread_key_create => _library._pthread_key_createPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_key_t )>> get pthread_key_delete => _library._pthread_key_deletePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(pthread_key_t )>> get pthread_getspecific => _library._pthread_getspecificPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_key_t , ffi.Pointer<ffi.Void> )>> get pthread_setspecific => _library._pthread_setspecificPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(pthread_t , ffi.Pointer<ffi.Int> )>> get pthread_getcpuclockid => _library._pthread_getcpuclockidPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> , ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> , ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> )>> get pthread_atfork => _library._pthread_atforkPtr;
ffi.Pointer<ffi.Uint32> get slab_magic => _library._slab_magic;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab_arena> )>> get slab_cache_create => _library._slab_cache_createPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> )>> get slab_cache_destroy => _library._slab_cache_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<slab> Function(ffi.Pointer<slab_cache> , ffi.Uint8 )>> get slab_get_with_order => _library._slab_get_with_orderPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab> )>> get slab_put_with_order => _library._slab_put_with_orderPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<slab> Function(ffi.Pointer<slab_cache> , ffi.Size )>> get slab_get_large => _library._slab_get_largePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab> )>> get slab_put_large => _library._slab_put_largePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<slab> Function(ffi.Pointer<slab_cache> , ffi.Size )>> get slab_get => _library._slab_getPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> , ffi.Pointer<slab> )>> get slab_put => _library._slab_putPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<slab_cache> )>> get slab_cache_check => _library._slab_cache_checkPtr;
ffi.Pointer<ffi.Double> get OVERHEAD_RATIO => _library._OVERHEAD_RATIO;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mempool> , ffi.Pointer<mempool_stats> )>> get mempool_stats1 => _library._mempool_stats1Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mempool> , ffi.Pointer<slab_cache> , ffi.Uint32 , ffi.Uint8 )>> get mempool_create_with_order => _library._mempool_create_with_orderPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mempool> )>> get mempool_destroy => _library._mempool_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<mempool> )>> get mempool_alloc => _library._mempool_allocPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mempool> , ffi.Pointer<mslab> , ffi.Pointer<ffi.Void> )>> get mslab_free => _library._mslab_freePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_class> , ffi.UnsignedInt , ffi.Float , ffi.UnsignedInt , ffi.Pointer<ffi.Float> )>> get small_class_create => _library._small_class_createPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Pointer<slab_cache> , ffi.Uint32 , ffi.UnsignedInt , ffi.Float , ffi.Pointer<ffi.Float> )>> get small_alloc_create => _library._small_alloc_createPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Int32 , ffi.Bool )>> get small_alloc_setopt => _library._small_alloc_setoptPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> )>> get small_alloc_destroy => _library._small_alloc_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<small_alloc> , ffi.Size )>> get smalloc => _library._smallocPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Pointer<ffi.Void> , ffi.Size )>> get smfree => _library._smfreePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Pointer<ffi.Void> , ffi.Size )>> get smfree_delayed => _library._smfree_delayedPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Size Function(ffi.Pointer<small_alloc> , ffi.Pointer<ffi.Void> )>> get small_ptr_compress => _library._small_ptr_compressPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<small_alloc> , ffi.Size )>> get small_ptr_decompress => _library._small_ptr_decompressPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<small_alloc> , ffi.Pointer<small_stats> , mempool_stats_cb , ffi.Pointer<ffi.Void> )>> get small_stats1 => _library._small_stats1Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsError => _library._Dart_IsErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsApiError => _library._Dart_IsApiErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsUnhandledExceptionError => _library._Dart_IsUnhandledExceptionErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsCompilationError => _library._Dart_IsCompilationErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsFatalError => _library._Dart_IsFatalErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Handle )>> get Dart_GetError => _library._Dart_GetErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_ErrorHasException => _library._Dart_ErrorHasExceptionPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_ErrorGetException => _library._Dart_ErrorGetExceptionPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_ErrorGetStackTrace => _library._Dart_ErrorGetStackTracePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Char> )>> get Dart_NewApiError => _library._Dart_NewApiErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Char> )>> get Dart_NewCompilationError => _library._Dart_NewCompilationErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_NewUnhandledExceptionError => _library._Dart_NewUnhandledExceptionErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Handle )>> get Dart_PropagateError => _library._Dart_PropagateErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_ToString => _library._Dart_ToStringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle , ffi.Handle )>> get Dart_IdentityEquals => _library._Dart_IdentityEqualsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_HandleFromPersistent => _library._Dart_HandleFromPersistentPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_WeakPersistentHandle )>> get Dart_HandleFromWeakPersistent => _library._Dart_HandleFromWeakPersistentPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_NewPersistentHandle => _library._Dart_NewPersistentHandlePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Handle , ffi.Handle )>> get Dart_SetPersistentHandle => _library._Dart_SetPersistentHandlePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Handle )>> get Dart_DeletePersistentHandle => _library._Dart_DeletePersistentHandlePtr;
ffi.Pointer<ffi.NativeFunction<Dart_WeakPersistentHandle Function(ffi.Handle , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>> get Dart_NewWeakPersistentHandle => _library._Dart_NewWeakPersistentHandlePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_WeakPersistentHandle )>> get Dart_DeleteWeakPersistentHandle => _library._Dart_DeleteWeakPersistentHandlePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_WeakPersistentHandle , ffi.IntPtr )>> get Dart_UpdateExternalSize => _library._Dart_UpdateExternalSizePtr;
ffi.Pointer<ffi.NativeFunction<Dart_FinalizableHandle Function(ffi.Handle , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>> get Dart_NewFinalizableHandle => _library._Dart_NewFinalizableHandlePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_FinalizableHandle , ffi.Handle )>> get Dart_DeleteFinalizableHandle => _library._Dart_DeleteFinalizableHandlePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_FinalizableHandle , ffi.Handle , ffi.IntPtr )>> get Dart_UpdateFinalizableExternalSize => _library._Dart_UpdateFinalizableExternalSizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>> get Dart_VersionString => _library._Dart_VersionStringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<Dart_IsolateFlags> )>> get Dart_IsolateFlagsInitialize => _library._Dart_IsolateFlagsInitializePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<Dart_InitializeParams> )>> get Dart_Initialize => _library._Dart_InitializePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>> get Dart_Cleanup => _library._Dart_CleanupPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Int , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> get Dart_SetVMFlags => _library._Dart_SetVMFlagsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Char> )>> get Dart_IsVMFlagSet => _library._Dart_IsVMFlagSetPtr;
ffi.Pointer<ffi.NativeFunction<Dart_Isolate Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.Pointer<ffi.Uint8> , ffi.Pointer<Dart_IsolateFlags> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> get Dart_CreateIsolateGroup => _library._Dart_CreateIsolateGroupPtr;
ffi.Pointer<ffi.NativeFunction<Dart_Isolate Function(Dart_Isolate , ffi.Pointer<ffi.Char> , Dart_IsolateShutdownCallback , Dart_IsolateCleanupCallback , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> get Dart_CreateIsolateInGroup => _library._Dart_CreateIsolateInGroupPtr;
ffi.Pointer<ffi.NativeFunction<Dart_Isolate Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.IntPtr , ffi.Pointer<Dart_IsolateFlags> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> get Dart_CreateIsolateGroupFromKernel => _library._Dart_CreateIsolateGroupFromKernelPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_ShutdownIsolate => _library._Dart_ShutdownIsolatePtr;
ffi.Pointer<ffi.NativeFunction<Dart_Isolate Function()>> get Dart_CurrentIsolate => _library._Dart_CurrentIsolatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>> get Dart_CurrentIsolateData => _library._Dart_CurrentIsolateDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(Dart_Isolate )>> get Dart_IsolateData => _library._Dart_IsolateDataPtr;
ffi.Pointer<ffi.NativeFunction<Dart_IsolateGroup Function()>> get Dart_CurrentIsolateGroup => _library._Dart_CurrentIsolateGroupPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>> get Dart_CurrentIsolateGroupData => _library._Dart_CurrentIsolateGroupDataPtr;
ffi.Pointer<ffi.NativeFunction<Dart_IsolateGroupId Function()>> get Dart_CurrentIsolateGroupId => _library._Dart_CurrentIsolateGroupIdPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(Dart_Isolate )>> get Dart_IsolateGroupData => _library._Dart_IsolateGroupDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_DebugName => _library._Dart_DebugNamePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(Dart_Isolate )>> get Dart_IsolateServiceId => _library._Dart_IsolateServiceIdPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_Isolate )>> get Dart_EnterIsolate => _library._Dart_EnterIsolatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_Isolate )>> get Dart_KillIsolate => _library._Dart_KillIsolatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int64 )>> get Dart_NotifyIdle => _library._Dart_NotifyIdlePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_NotifyDetach => _library._Dart_NotifyDetachPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_NotifyLowMemory => _library._Dart_NotifyLowMemoryPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int32 Function(ffi.Int32 )>> get Dart_SetPerformanceMode => _library._Dart_SetPerformanceModePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_StartProfiling => _library._Dart_StartProfilingPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_StopProfiling => _library._Dart_StopProfilingPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_ThreadDisableProfiling => _library._Dart_ThreadDisableProfilingPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_ThreadEnableProfiling => _library._Dart_ThreadEnableProfilingPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Void> , ffi.IntPtr )>> get Dart_AddSymbols => _library._Dart_AddSymbolsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_ExitIsolate => _library._Dart_ExitIsolatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Bool )>> get Dart_CreateSnapshot => _library._Dart_CreateSnapshotPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>> get Dart_IsKernel => _library._Dart_IsKernelPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(Dart_Isolate )>> get Dart_IsolateMakeRunnable => _library._Dart_IsolateMakeRunnablePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_MessageNotifyCallback )>> get Dart_SetMessageNotifyCallback => _library._Dart_SetMessageNotifyCallbackPtr;
ffi.Pointer<ffi.NativeFunction<Dart_MessageNotifyCallback Function()>> get Dart_GetMessageNotifyCallback => _library._Dart_GetMessageNotifyCallbackPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_ShouldPauseOnStart => _library._Dart_ShouldPauseOnStartPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Bool )>> get Dart_SetShouldPauseOnStart => _library._Dart_SetShouldPauseOnStartPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_IsPausedOnStart => _library._Dart_IsPausedOnStartPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Bool )>> get Dart_SetPausedOnStart => _library._Dart_SetPausedOnStartPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_ShouldPauseOnExit => _library._Dart_ShouldPauseOnExitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Bool )>> get Dart_SetShouldPauseOnExit => _library._Dart_SetShouldPauseOnExitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_IsPausedOnExit => _library._Dart_IsPausedOnExitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Bool )>> get Dart_SetPausedOnExit => _library._Dart_SetPausedOnExitPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Handle )>> get Dart_SetStickyError => _library._Dart_SetStickyErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_HasStickyError => _library._Dart_HasStickyErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_GetStickyError => _library._Dart_GetStickyErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_HandleMessage => _library._Dart_HandleMessagePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Int64 )>> get Dart_WaitForEvent => _library._Dart_WaitForEventPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_HandleServiceMessages => _library._Dart_HandleServiceMessagesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_HasServiceMessages => _library._Dart_HasServiceMessagesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_RunLoop => _library._Dart_RunLoopPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Bool , Dart_Port , Dart_Port , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> get Dart_RunLoopAsync => _library._Dart_RunLoopAsyncPtr;
ffi.Pointer<ffi.NativeFunction<Dart_Port Function()>> get Dart_GetMainPortId => _library._Dart_GetMainPortIdPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_HasLivePorts => _library._Dart_HasLivePortsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port , ffi.Handle )>> get Dart_Post => _library._Dart_PostPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_Port )>> get Dart_NewSendPort => _library._Dart_NewSendPortPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<Dart_Port> )>> get Dart_SendPortGetId => _library._Dart_SendPortGetIdPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_EnterScope => _library._Dart_EnterScopePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_ExitScope => _library._Dart_ExitScopePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Uint8> Function(ffi.IntPtr )>> get Dart_ScopeAllocate => _library._Dart_ScopeAllocatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_Null => _library._Dart_NullPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsNull => _library._Dart_IsNullPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_EmptyString => _library._Dart_EmptyStringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_TypeDynamic => _library._Dart_TypeDynamicPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_TypeVoid => _library._Dart_TypeVoidPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_TypeNever => _library._Dart_TypeNeverPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.Pointer<ffi.Bool> )>> get Dart_ObjectEquals => _library._Dart_ObjectEqualsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.Pointer<ffi.Bool> )>> get Dart_ObjectIsType => _library._Dart_ObjectIsTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsInstance => _library._Dart_IsInstancePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsNumber => _library._Dart_IsNumberPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsInteger => _library._Dart_IsIntegerPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsDouble => _library._Dart_IsDoublePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsBoolean => _library._Dart_IsBooleanPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsString => _library._Dart_IsStringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsStringLatin1 => _library._Dart_IsStringLatin1Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsExternalString => _library._Dart_IsExternalStringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsList => _library._Dart_IsListPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsMap => _library._Dart_IsMapPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsLibrary => _library._Dart_IsLibraryPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsType => _library._Dart_IsTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsFunction => _library._Dart_IsFunctionPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsVariable => _library._Dart_IsVariablePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsTypeVariable => _library._Dart_IsTypeVariablePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsClosure => _library._Dart_IsClosurePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsTypedData => _library._Dart_IsTypedDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsByteBuffer => _library._Dart_IsByteBufferPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsFuture => _library._Dart_IsFuturePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_InstanceGetType => _library._Dart_InstanceGetTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_ClassName => _library._Dart_ClassNamePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_FunctionName => _library._Dart_FunctionNamePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_FunctionOwner => _library._Dart_FunctionOwnerPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Bool> )>> get Dart_FunctionIsStatic => _library._Dart_FunctionIsStaticPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>> get Dart_IsTearOff => _library._Dart_IsTearOffPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_ClosureFunction => _library._Dart_ClosureFunctionPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_ClassLibrary => _library._Dart_ClassLibraryPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Bool> )>> get Dart_IntegerFitsIntoInt64 => _library._Dart_IntegerFitsIntoInt64Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Bool> )>> get Dart_IntegerFitsIntoUint64 => _library._Dart_IntegerFitsIntoUint64Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Int64 )>> get Dart_NewInteger => _library._Dart_NewIntegerPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Uint64 )>> get Dart_NewIntegerFromUint64 => _library._Dart_NewIntegerFromUint64Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Char> )>> get Dart_NewIntegerFromHexCString => _library._Dart_NewIntegerFromHexCStringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Int64> )>> get Dart_IntegerToInt64 => _library._Dart_IntegerToInt64Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Uint64> )>> get Dart_IntegerToUint64 => _library._Dart_IntegerToUint64Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> get Dart_IntegerToHexCString => _library._Dart_IntegerToHexCStringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Double )>> get Dart_NewDouble => _library._Dart_NewDoublePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Double> )>> get Dart_DoubleValue => _library._Dart_DoubleValuePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.Handle )>> get Dart_GetStaticMethodClosure => _library._Dart_GetStaticMethodClosurePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_True => _library._Dart_TruePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_False => _library._Dart_FalsePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Bool )>> get Dart_NewBoolean => _library._Dart_NewBooleanPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Bool> )>> get Dart_BooleanValue => _library._Dart_BooleanValuePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.IntPtr> )>> get Dart_StringLength => _library._Dart_StringLengthPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Char> )>> get Dart_NewStringFromCString => _library._Dart_NewStringFromCStringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>> get Dart_NewStringFromUTF8 => _library._Dart_NewStringFromUTF8Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Uint16> , ffi.IntPtr )>> get Dart_NewStringFromUTF16 => _library._Dart_NewStringFromUTF16Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Int32> , ffi.IntPtr )>> get Dart_NewStringFromUTF32 => _library._Dart_NewStringFromUTF32Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Uint8> , ffi.IntPtr , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>> get Dart_NewExternalLatin1String => _library._Dart_NewExternalLatin1StringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Uint16> , ffi.IntPtr , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>> get Dart_NewExternalUTF16String => _library._Dart_NewExternalUTF16StringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> get Dart_StringToCString => _library._Dart_StringToCStringPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> )>> get Dart_StringToUTF8 => _library._Dart_StringToUTF8Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Uint8> , ffi.Pointer<ffi.IntPtr> )>> get Dart_StringToLatin1 => _library._Dart_StringToLatin1Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Uint16> , ffi.Pointer<ffi.IntPtr> )>> get Dart_StringToUTF16 => _library._Dart_StringToUTF16Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.IntPtr> )>> get Dart_StringStorageSize => _library._Dart_StringStorageSizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Void>> )>> get Dart_StringGetProperties => _library._Dart_StringGetPropertiesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.IntPtr )>> get Dart_NewList => _library._Dart_NewListPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.IntPtr )>> get Dart_NewListOf => _library._Dart_NewListOfPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.IntPtr )>> get Dart_NewListOfType => _library._Dart_NewListOfTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.IntPtr )>> get Dart_NewListOfTypeFilled => _library._Dart_NewListOfTypeFilledPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.IntPtr> )>> get Dart_ListLength => _library._Dart_ListLengthPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.IntPtr )>> get Dart_ListGetAt => _library._Dart_ListGetAtPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.IntPtr , ffi.IntPtr , ffi.Pointer<ffi.Handle> )>> get Dart_ListGetRange => _library._Dart_ListGetRangePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.IntPtr , ffi.Handle )>> get Dart_ListSetAt => _library._Dart_ListSetAtPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.IntPtr , ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>> get Dart_ListGetAsBytes => _library._Dart_ListGetAsBytesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.IntPtr , ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>> get Dart_ListSetAsBytes => _library._Dart_ListSetAsBytesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle )>> get Dart_MapGetAt => _library._Dart_MapGetAtPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle )>> get Dart_MapContainsKey => _library._Dart_MapContainsKeyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_MapKeys => _library._Dart_MapKeysPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int32 Function(ffi.Handle )>> get Dart_GetTypeOfTypedData => _library._Dart_GetTypeOfTypedDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int32 Function(ffi.Handle )>> get Dart_GetTypeOfExternalTypedData => _library._Dart_GetTypeOfExternalTypedDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.IntPtr )>> get Dart_NewTypedData => _library._Dart_NewTypedDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.Pointer<ffi.Void> , ffi.IntPtr )>> get Dart_NewExternalTypedData => _library._Dart_NewExternalTypedDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.Pointer<ffi.Void> , ffi.IntPtr , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>> get Dart_NewExternalTypedDataWithFinalizer => _library._Dart_NewExternalTypedDataWithFinalizerPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.Pointer<ffi.Void> , ffi.IntPtr , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>> get Dart_NewUnmodifiableExternalTypedDataWithFinalizer => _library._Dart_NewUnmodifiableExternalTypedDataWithFinalizerPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_NewByteBuffer => _library._Dart_NewByteBufferPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Int32> , ffi.Pointer<ffi.Pointer<ffi.Void>> , ffi.Pointer<ffi.IntPtr> )>> get Dart_TypedDataAcquireData => _library._Dart_TypedDataAcquireDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_TypedDataReleaseData => _library._Dart_TypedDataReleaseDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_GetDataFromByteBuffer => _library._Dart_GetDataFromByteBufferPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.Int , ffi.Pointer<ffi.Handle> )>> get Dart_New => _library._Dart_NewPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_Allocate => _library._Dart_AllocatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.IntPtr , ffi.Pointer<ffi.IntPtr> )>> get Dart_AllocateWithNativeFields => _library._Dart_AllocateWithNativeFieldsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.Int , ffi.Pointer<ffi.Handle> )>> get Dart_Invoke => _library._Dart_InvokePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Int , ffi.Pointer<ffi.Handle> )>> get Dart_InvokeClosure => _library._Dart_InvokeClosurePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.Int , ffi.Pointer<ffi.Handle> )>> get Dart_InvokeConstructor => _library._Dart_InvokeConstructorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle )>> get Dart_GetField => _library._Dart_GetFieldPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.Handle )>> get Dart_SetField => _library._Dart_SetFieldPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_ThrowException => _library._Dart_ThrowExceptionPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle )>> get Dart_ReThrowException => _library._Dart_ReThrowExceptionPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Int> )>> get Dart_GetNativeInstanceFieldCount => _library._Dart_GetNativeInstanceFieldCountPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Int , ffi.Pointer<ffi.IntPtr> )>> get Dart_GetNativeInstanceField => _library._Dart_GetNativeInstanceFieldPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Int , ffi.IntPtr )>> get Dart_SetNativeInstanceField => _library._Dart_SetNativeInstanceFieldPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(Dart_NativeArguments )>> get Dart_GetNativeIsolateGroupData => _library._Dart_GetNativeIsolateGroupDataPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_NativeArguments , ffi.Int , ffi.Pointer<Dart_NativeArgument_Descriptor> , ffi.Pointer<Dart_NativeArgument_Value> )>> get Dart_GetNativeArguments => _library._Dart_GetNativeArgumentsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_NativeArguments , ffi.Int )>> get Dart_GetNativeArgument => _library._Dart_GetNativeArgumentPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(Dart_NativeArguments )>> get Dart_GetNativeArgumentCount => _library._Dart_GetNativeArgumentCountPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_NativeArguments , ffi.Int , ffi.Int , ffi.Pointer<ffi.IntPtr> )>> get Dart_GetNativeFieldsOfArgument => _library._Dart_GetNativeFieldsOfArgumentPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_NativeArguments , ffi.Pointer<ffi.IntPtr> )>> get Dart_GetNativeReceiver => _library._Dart_GetNativeReceiverPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_NativeArguments , ffi.Int , ffi.Pointer<ffi.Pointer<ffi.Void>> )>> get Dart_GetNativeStringArgument => _library._Dart_GetNativeStringArgumentPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_NativeArguments , ffi.Int , ffi.Pointer<ffi.Int64> )>> get Dart_GetNativeIntegerArgument => _library._Dart_GetNativeIntegerArgumentPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_NativeArguments , ffi.Int , ffi.Pointer<ffi.Bool> )>> get Dart_GetNativeBooleanArgument => _library._Dart_GetNativeBooleanArgumentPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_NativeArguments , ffi.Int , ffi.Pointer<ffi.Double> )>> get Dart_GetNativeDoubleArgument => _library._Dart_GetNativeDoubleArgumentPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_NativeArguments , ffi.Handle )>> get Dart_SetReturnValue => _library._Dart_SetReturnValuePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_NativeArguments , Dart_WeakPersistentHandle )>> get Dart_SetWeakHandleReturnValue => _library._Dart_SetWeakHandleReturnValuePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_NativeArguments , ffi.Bool )>> get Dart_SetBooleanReturnValue => _library._Dart_SetBooleanReturnValuePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_NativeArguments , ffi.Int64 )>> get Dart_SetIntegerReturnValue => _library._Dart_SetIntegerReturnValuePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_NativeArguments , ffi.Double )>> get Dart_SetDoubleReturnValue => _library._Dart_SetDoubleReturnValuePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_EnvironmentCallback )>> get Dart_SetEnvironmentCallback => _library._Dart_SetEnvironmentCallbackPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , Dart_NativeEntryResolver , Dart_NativeEntrySymbol )>> get Dart_SetNativeResolver => _library._Dart_SetNativeResolverPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<Dart_NativeEntryResolver> )>> get Dart_GetNativeResolver => _library._Dart_GetNativeResolverPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<Dart_NativeEntrySymbol> )>> get Dart_GetNativeSymbol => _library._Dart_GetNativeSymbolPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , Dart_FfiNativeResolver )>> get Dart_SetFfiNativeResolver => _library._Dart_SetFfiNativeResolverPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_LibraryTagHandler )>> get Dart_SetLibraryTagHandler => _library._Dart_SetLibraryTagHandlerPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_DeferredLoadHandler )>> get Dart_SetDeferredLoadHandler => _library._Dart_SetDeferredLoadHandlerPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.IntPtr , ffi.Pointer<ffi.Uint8> , ffi.Pointer<ffi.Uint8> )>> get Dart_DeferredLoadComplete => _library._Dart_DeferredLoadCompletePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.IntPtr , ffi.Pointer<ffi.Char> , ffi.Bool )>> get Dart_DeferredLoadCompleteError => _library._Dart_DeferredLoadCompleteErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle )>> get Dart_DefaultCanonicalizeUrl => _library._Dart_DefaultCanonicalizeUrlPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>> get Dart_LoadScriptFromKernel => _library._Dart_LoadScriptFromKernelPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_RootLibrary => _library._Dart_RootLibraryPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_SetRootLibrary => _library._Dart_SetRootLibraryPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.IntPtr , ffi.Pointer<ffi.Handle> )>> get Dart_GetType => _library._Dart_GetTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.IntPtr , ffi.Pointer<ffi.Handle> )>> get Dart_GetNullableType => _library._Dart_GetNullableTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle , ffi.IntPtr , ffi.Pointer<ffi.Handle> )>> get Dart_GetNonNullableType => _library._Dart_GetNonNullableTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_TypeToNullableType => _library._Dart_TypeToNullableTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_TypeToNonNullableType => _library._Dart_TypeToNonNullableTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Bool> )>> get Dart_IsNullableType => _library._Dart_IsNullableTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Bool> )>> get Dart_IsNonNullableType => _library._Dart_IsNonNullableTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Bool> )>> get Dart_IsLegacyType => _library._Dart_IsLegacyTypePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle )>> get Dart_GetClass => _library._Dart_GetClassPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_LibraryUrl => _library._Dart_LibraryUrlPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_LibraryResolvedUrl => _library._Dart_LibraryResolvedUrlPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_GetLoadedLibraries => _library._Dart_GetLoadedLibrariesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>> get Dart_LookupLibrary => _library._Dart_LookupLibraryPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Handle )>> get Dart_LibraryHandleError => _library._Dart_LibraryHandleErrorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>> get Dart_LoadLibraryFromKernel => _library._Dart_LoadLibraryFromKernelPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Bool )>> get Dart_FinalizeLoading => _library._Dart_FinalizeLoadingPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Pointer<ffi.Void>> )>> get Dart_GetPeer => _library._Dart_GetPeerPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<ffi.Void> )>> get Dart_SetPeer => _library._Dart_SetPeerPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Isolate )>> get Dart_IsKernelIsolate => _library._Dart_IsKernelIsolatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_KernelIsolateIsRunning => _library._Dart_KernelIsolateIsRunningPtr;
ffi.Pointer<ffi.NativeFunction<Dart_Port Function()>> get Dart_KernelPort => _library._Dart_KernelPortPtr;
ffi.Pointer<ffi.NativeFunction<Dart_KernelCompilationResult Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.IntPtr , ffi.Bool , ffi.Bool , ffi.Pointer<ffi.Char> , ffi.Int32 )>> get Dart_CompileToKernel => _library._Dart_CompileToKernelPtr;
ffi.Pointer<ffi.NativeFunction<Dart_KernelCompilationResult Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.IntPtr , ffi.Bool , ffi.Pointer<ffi.Char> , ffi.Bool , ffi.Int32 )>> get Dart_CompileToKernelWithGivenNullsafety => _library._Dart_CompileToKernelWithGivenNullsafetyPtr;
ffi.Pointer<ffi.NativeFunction<Dart_KernelCompilationResult Function()>> get Dart_KernelListDependencies => _library._Dart_KernelListDependenciesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>> get Dart_SetDartLibrarySourcesKernel => _library._Dart_SetDartLibrarySourcesKernelPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Uint8> , ffi.Pointer<ffi.Uint8> , ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>> get Dart_DetectNullSafety => _library._Dart_DetectNullSafetyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Isolate )>> get Dart_IsServiceIsolate => _library._Dart_IsServiceIsolatePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port , ffi.Pointer<ffi.Pointer<ffi.Char>> )>> get Dart_WriteProfileToTimeline => _library._Dart_WriteProfileToTimelinePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_Precompile => _library._Dart_PrecompilePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.IntPtr )>> get Dart_LoadingUnitLibraryUris => _library._Dart_LoadingUnitLibraryUrisPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_StreamingWriteCallback , ffi.Pointer<ffi.Void> , ffi.Bool , ffi.Pointer<ffi.Void> )>> get Dart_CreateAppAOTSnapshotAsAssembly => _library._Dart_CreateAppAOTSnapshotAsAssemblyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_CreateLoadingUnitCallback , ffi.Pointer<ffi.Void> , ffi.Bool , Dart_StreamingWriteCallback , Dart_StreamingCloseCallback )>> get Dart_CreateAppAOTSnapshotAsAssemblies => _library._Dart_CreateAppAOTSnapshotAsAssembliesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_StreamingWriteCallback , ffi.Pointer<ffi.Void> , ffi.Bool , ffi.Pointer<ffi.Void> )>> get Dart_CreateAppAOTSnapshotAsElf => _library._Dart_CreateAppAOTSnapshotAsElfPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_CreateLoadingUnitCallback , ffi.Pointer<ffi.Void> , ffi.Bool , Dart_StreamingWriteCallback , Dart_StreamingCloseCallback )>> get Dart_CreateAppAOTSnapshotAsElfs => _library._Dart_CreateAppAOTSnapshotAsElfsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_StreamingWriteCallback , ffi.Pointer<ffi.Void> )>> get Dart_CreateVMAOTSnapshotAsAssembly => _library._Dart_CreateVMAOTSnapshotAsAssemblyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_SortClasses => _library._Dart_SortClassesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> )>> get Dart_CreateAppJITSnapshotAsBlobs => _library._Dart_CreateAppJITSnapshotAsBlobsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> )>> get Dart_CreateCoreJITSnapshotAsBlobs => _library._Dart_CreateCoreJITSnapshotAsBlobsPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> )>> get Dart_GetObfuscationMap => _library._Dart_GetObfuscationMapPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function()>> get Dart_IsPrecompiledRuntime => _library._Dart_IsPrecompiledRuntimePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>> get Dart_DumpNativeStackTrace => _library._Dart_DumpNativeStackTracePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get Dart_PrepareToAbort => _library._Dart_PrepareToAbortPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port , ffi.Pointer<Dart_CObject> )>> get Dart_PostCObject => _library._Dart_PostCObjectPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port , ffi.Int64 )>> get Dart_PostInteger => _library._Dart_PostIntegerPtr;
ffi.Pointer<ffi.NativeFunction<Dart_Port Function(ffi.Pointer<ffi.Char> , Dart_NativeMessageHandler , ffi.Bool )>> get Dart_NewNativePort => _library._Dart_NewNativePortPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port )>> get Dart_CloseNativePort => _library._Dart_CloseNativePortPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_CompileAll => _library._Dart_CompileAllPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Handle Function()>> get Dart_FinalizeAllClasses => _library._Dart_FinalizeAllClassesPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Void> )>> get Dart_ExecuteInternalCommand => _library._Dart_ExecuteInternalCommandPtr;
ffi.Pointer<ffi.NativeFunction<ffi.IntPtr Function(ffi.Pointer<ffi.Void> )>> get Dart_InitializeApiDL => _library._Dart_InitializeApiDLPtr;
ffi.Pointer<Dart_PostCObject_Type> get Dart_PostCObject_DL => _library._Dart_PostCObject_DL;
ffi.Pointer<Dart_PostInteger_Type> get Dart_PostInteger_DL => _library._Dart_PostInteger_DL;
ffi.Pointer<Dart_NewNativePort_Type> get Dart_NewNativePort_DL => _library._Dart_NewNativePort_DL;
ffi.Pointer<Dart_CloseNativePort_Type> get Dart_CloseNativePort_DL => _library._Dart_CloseNativePort_DL;
ffi.Pointer<Dart_IsError_Type> get Dart_IsError_DL => _library._Dart_IsError_DL;
ffi.Pointer<Dart_IsApiError_Type> get Dart_IsApiError_DL => _library._Dart_IsApiError_DL;
ffi.Pointer<Dart_IsUnhandledExceptionError_Type> get Dart_IsUnhandledExceptionError_DL => _library._Dart_IsUnhandledExceptionError_DL;
ffi.Pointer<Dart_IsCompilationError_Type> get Dart_IsCompilationError_DL => _library._Dart_IsCompilationError_DL;
ffi.Pointer<Dart_IsFatalError_Type> get Dart_IsFatalError_DL => _library._Dart_IsFatalError_DL;
ffi.Pointer<Dart_GetError_Type> get Dart_GetError_DL => _library._Dart_GetError_DL;
ffi.Pointer<Dart_ErrorHasException_Type> get Dart_ErrorHasException_DL => _library._Dart_ErrorHasException_DL;
ffi.Pointer<Dart_ErrorGetException_Type> get Dart_ErrorGetException_DL => _library._Dart_ErrorGetException_DL;
ffi.Pointer<Dart_ErrorGetStackTrace_Type> get Dart_ErrorGetStackTrace_DL => _library._Dart_ErrorGetStackTrace_DL;
ffi.Pointer<Dart_NewApiError_Type> get Dart_NewApiError_DL => _library._Dart_NewApiError_DL;
ffi.Pointer<Dart_NewCompilationError_Type> get Dart_NewCompilationError_DL => _library._Dart_NewCompilationError_DL;
ffi.Pointer<Dart_NewUnhandledExceptionError_Type> get Dart_NewUnhandledExceptionError_DL => _library._Dart_NewUnhandledExceptionError_DL;
ffi.Pointer<Dart_PropagateError_Type> get Dart_PropagateError_DL => _library._Dart_PropagateError_DL;
ffi.Pointer<Dart_HandleFromPersistent_Type> get Dart_HandleFromPersistent_DL => _library._Dart_HandleFromPersistent_DL;
ffi.Pointer<Dart_HandleFromWeakPersistent_Type> get Dart_HandleFromWeakPersistent_DL => _library._Dart_HandleFromWeakPersistent_DL;
ffi.Pointer<Dart_NewPersistentHandle_Type> get Dart_NewPersistentHandle_DL => _library._Dart_NewPersistentHandle_DL;
ffi.Pointer<Dart_SetPersistentHandle_Type> get Dart_SetPersistentHandle_DL => _library._Dart_SetPersistentHandle_DL;
ffi.Pointer<Dart_DeletePersistentHandle_Type> get Dart_DeletePersistentHandle_DL => _library._Dart_DeletePersistentHandle_DL;
ffi.Pointer<Dart_NewWeakPersistentHandle_Type> get Dart_NewWeakPersistentHandle_DL => _library._Dart_NewWeakPersistentHandle_DL;
ffi.Pointer<Dart_DeleteWeakPersistentHandle_Type> get Dart_DeleteWeakPersistentHandle_DL => _library._Dart_DeleteWeakPersistentHandle_DL;
ffi.Pointer<Dart_UpdateExternalSize_Type> get Dart_UpdateExternalSize_DL => _library._Dart_UpdateExternalSize_DL;
ffi.Pointer<Dart_NewFinalizableHandle_Type> get Dart_NewFinalizableHandle_DL => _library._Dart_NewFinalizableHandle_DL;
ffi.Pointer<Dart_DeleteFinalizableHandle_Type> get Dart_DeleteFinalizableHandle_DL => _library._Dart_DeleteFinalizableHandle_DL;
ffi.Pointer<Dart_UpdateFinalizableExternalSize_Type> get Dart_UpdateFinalizableExternalSize_DL => _library._Dart_UpdateFinalizableExternalSize_DL;
ffi.Pointer<Dart_Post_Type> get Dart_Post_DL => _library._Dart_Post_DL;
ffi.Pointer<Dart_NewSendPort_Type> get Dart_NewSendPort_DL => _library._Dart_NewSendPort_DL;
ffi.Pointer<Dart_SendPortGetId_Type> get Dart_SendPortGetId_DL => _library._Dart_SendPortGetId_DL;
ffi.Pointer<Dart_EnterScope_Type> get Dart_EnterScope_DL => _library._Dart_EnterScope_DL;
ffi.Pointer<Dart_ExitScope_Type> get Dart_ExitScope_DL => _library._Dart_ExitScope_DL;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_listener_t> , ffi.Pointer<transport_listener_configuration_t> , ffi.Uint8 )>> get transport_listener_initialize => _library._transport_listener_initializePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_listener_t> )>> get transport_listener_close => _library._transport_listener_closePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<transport_listener_t> , ffi.Pointer<ffi.Pointer<io_uring_cqe>> )>> get transport_listener_reap => _library._transport_listener_reapPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_listener_t> )>> get transport_listener_destroy => _library._transport_listener_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Int32 )>> get transport_server_initialize_tcp => _library._transport_server_initialize_tcpPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Int32 )>> get transport_server_initialize_udp => _library._transport_server_initialize_udpPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> )>> get transport_server_initialize_unix_stream => _library._transport_server_initialize_unix_streamPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_server_t> , ffi.Pointer<transport_server_configuration_t> , ffi.Pointer<ffi.Char> )>> get transport_server_initialize_unix_dgram => _library._transport_server_initialize_unix_dgramPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<ffi.Pointer<ffi.Char>> , ffi.Pointer<ffi.Char> , ffi.Uint32 )>> get strindex => _library._strindexPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Uint32 Function(ffi.Pointer<ffi.Pointer<ffi.Char>> , ffi.Pointer<ffi.Char> , ffi.Uint32 , ffi.Uint32 )>> get strnindex => _library._strnindexPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int )>> get close_all_xcpt => _library._close_all_xcptPtr;
ffi.Pointer<ffi.NativeFunction<ssize_t Function(ffi.Int , ffi.Pointer<ffi.Char> )>> get fdprintf => _library._fdprintfPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> )>> get find_path => _library._find_pathPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> )>> get abspath => _library._abspathPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> )>> get mkdirpath => _library._mkdirpathPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.LongLong )>> get int2str => _library._int2strPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get fpconv_check => _library._fpconv_checkPtr;
ffi.Pointer<ffi.Pointer<ffi.Pointer<ffi.Char>>> get precision_fmts => _library._precision_fmts;
ffi.Pointer<ffi.NativeFunction<ffi.Size Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Size )>> get strlcpy => _library._strlcpyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Size Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Size )>> get strlcat => _library._strlcatPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> , ffi.Size )>> get utf8_check_printable => _library._utf8_check_printablePtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> , ffi.Int , ffi.Size )>> get memrchr => _library._memrchrPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> , ffi.Int , ffi.Pointer<ffi.Char> )>> get json_escape => _library._json_escapePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Double , ffi.Uint64 , ffi.Int )>> get double_compare_uint64 => _library._double_compare_uint64Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Double , ffi.Int64 , ffi.Int )>> get double_compare_nint64 => _library._double_compare_nint64Ptr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Double )>> get thread_sleep => _library._thread_sleepPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Size )>> get getenv_safe => _library._getenv_safePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<transport_listener_pool_t> Function()>> get transport_listener_pool_initialize => _library._transport_listener_pool_initializePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_listener_pool_t> , ffi.Pointer<transport_listener_t> )>> get transport_listener_pool_add => _library._transport_listener_pool_addPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_listener_pool_t> , ffi.Pointer<transport_listener_t> )>> get transport_listener_pool_remove => _library._transport_listener_pool_removePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Int32 )>> get transport_client_initialize_tcp => _library._transport_client_initialize_tcpPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Int32 , ffi.Pointer<ffi.Char> , ffi.Int32 )>> get transport_client_initialize_udp => _library._transport_client_initialize_udpPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> )>> get transport_client_initialize_unix_stream => _library._transport_client_initialize_unix_streamPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_client_t> , ffi.Pointer<transport_client_configuration_t> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>> get transport_client_initialize_unix_dgram => _library._transport_client_initialize_unix_dgramPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<sockaddr> Function(ffi.Pointer<transport_client_t> )>> get transport_client_get_destination_address => _library._transport_client_get_destination_addressPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<mh_i32_t> Function()>> get mh_i32_new => _library._mh_i32_newPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> )>> get mh_i32_clear => _library._mh_i32_clearPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> )>> get mh_i32_delete => _library._mh_i32_deletePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> , ffi.Int32 )>> get mh_i32_resize => _library._mh_i32_resizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mh_i32_t> , mh_int_t , mh_int_t , ffi.Int32 )>> get mh_i32_start_resize => _library._mh_i32_start_resizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mh_i32_t> , mh_int_t , ffi.Int32 )>> get mh_i32_reserve => _library._mh_i32_reservePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> , mh_int_t , ffi.Int32 )>> get mh_i32_del_resize => _library._mh_i32_del_resizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Size Function(ffi.Pointer<mh_i32_t> )>> get mh_i32_memsize => _library._mh_i32_memsizePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mh_i32_t> )>> get mh_i32_dump => _library._mh_i32_dumpPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<transport_worker_t> , ffi.Pointer<transport_worker_configuration_t> , ffi.Uint8 )>> get transport_worker_initialize => _library._transport_worker_initializePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint32 )>> get transport_worker_custom => _library._transport_worker_customPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint16 , ffi.Uint32 , ffi.Int64 , ffi.Uint16 , ffi.Uint8 )>> get transport_worker_add_write => _library._transport_worker_add_writePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint16 , ffi.Uint32 , ffi.Int64 , ffi.Uint16 , ffi.Uint8 , ffi.Uint16 )>> get transport_worker_add_read => _library._transport_worker_add_readPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint16 , ffi.Pointer<sockaddr> , ffi.Int32 , ffi.Int , ffi.Int64 , ffi.Uint16 , ffi.Uint8 , ffi.Uint16 )>> get transport_worker_add_send_message => _library._transport_worker_add_send_messagePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint32 , ffi.Uint16 , ffi.Int32 , ffi.Int , ffi.Int64 , ffi.Uint16 , ffi.Uint8 )>> get transport_worker_add_receive_message => _library._transport_worker_add_receive_messagePtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> )>> get transport_worker_submit => _library._transport_worker_submitPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<transport_worker_t> )>> get transport_worker_get_sequence => _library._transport_worker_get_sequencePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 )>> get transport_worker_release_sequence => _library._transport_worker_release_sequencePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<transport_worker_sequence_element_t> Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 )>> get transport_worker_sequence_get_last_element => _library._transport_worker_sequence_get_last_elementPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<transport_worker_sequence_element_t> Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 )>> get transport_worker_sequence_get_first_element => _library._transport_worker_sequence_get_first_elementPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<transport_worker_sequence_element_t> Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 , ffi.Pointer<transport_worker_sequence_element_t> )>> get transport_worker_sequence_get_next_element => _library._transport_worker_sequence_get_next_elementPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 , ffi.Pointer<transport_worker_sequence_element_t> )>> get transport_worker_sequence_delete_element => _library._transport_worker_sequence_delete_elementPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_worker_t> , ffi.Uint16 , ffi.Pointer<transport_worker_sequence_element_t> )>> get transport_worker_sequence_release_element => _library._transport_worker_sequence_release_elementPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<sockaddr> Function(ffi.Pointer<transport_worker_t> , ffi.Int32 , ffi.Int )>> get transport_worker_get_datagram_address => _library._transport_worker_get_datagram_addressPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Uint32 , ffi.Pointer<ffi.Pointer<io_uring_cqe>> , ffi.Pointer<io_uring> )>> get transport_worker_peek => _library._transport_worker_peekPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_t> , ffi.Pointer<transport_listener_configuration_t> , ffi.Pointer<transport_worker_configuration_t> , ffi.Pointer<transport_worker_configuration_t> )>> get transport_initialize => _library._transport_initializePtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Pointer<io_uring_cqe>> Function(ffi.Uint32 )>> get transport_allocate_cqes => _library._transport_allocate_cqesPtr;
...
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<transport_t> )>> get transport_destroy => _library._transport_destroyPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int )>> get transport_close_descritor => _library._transport_close_descritorPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> )>> get transport_file_open => _library._transport_file_openPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int64 Function(ffi.Uint64 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint16 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint16 )>> get transport_socket_create_tcp => _library._transport_socket_create_tcpPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int64 Function(ffi.Uint64 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint16 , ffi.Pointer<ip_mreqn> , ffi.Uint32 )>> get transport_socket_create_udp => _library._transport_socket_create_udpPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int64 Function(ffi.Uint64 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 )>> get transport_socket_create_unix_stream => _library._transport_socket_create_unix_streamPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int64 Function(ffi.Uint64 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 , ffi.Uint32 )>> get transport_socket_create_unix_dgram => _library._transport_socket_create_unix_dgramPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ip_mreqn> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Int )>> get transport_socket_multicast_create_request => _library._transport_socket_multicast_create_requestPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Int )>> get transport_socket_multicast_add_membership => _library._transport_socket_multicast_add_membershipPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Int )>> get transport_socket_multicast_drop_membership => _library._transport_socket_multicast_drop_membershipPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>> get transport_socket_multicast_add_source_membership => _library._transport_socket_multicast_add_source_membershipPtr;
ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Int , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>> get transport_socket_multicast_drop_source_membership => _library._transport_socket_multicast_drop_source_membershipPtr;
...
typedef mempool_stats_cb = ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mempool_stats> , ffi.Pointer<ffi.Void> )>>;
...
typedef Dart_HandleFinalizer = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> )>>;
...
/// address ranges.
typedef Dart_OnNewCodeCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<Dart_CodeObserver> , ffi.Pointer<ffi.Char> , ffi.UintPtr , ffi.UintPtr )>>;
...
typedef Dart_IsolateGroupCreateCallback = ffi.Pointer<ffi.NativeFunction<Dart_Isolate Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<Dart_IsolateFlags> , ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Pointer<ffi.Char>> )>>;
...
typedef Dart_InitializeIsolateCallback = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Pointer<ffi.Void>> , ffi.Pointer<ffi.Pointer<ffi.Char>> )>>;
...
/// when it was created.
typedef Dart_IsolateShutdownCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> )>>;
...
/// \param isolate_data The same callback data which was passed to the isolate
/// when it was created.
typedef Dart_IsolateCleanupCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Void> )>>;
...
/// \param isolate_group_data The same callback data which was passed to the
/// isolate group when it was created.
typedef Dart_IsolateGroupCleanupCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>>;
...
typedef Dart_FileOpenCallback = ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Char> , ffi.Bool )>>;
...
typedef Dart_FileReadCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Pointer<ffi.Uint8>> , ffi.Pointer<ffi.IntPtr> , ffi.Pointer<ffi.Void> )>>;
...
/// \param stream Handle to the opened file.
typedef Dart_FileWriteCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> , ffi.IntPtr , ffi.Pointer<ffi.Void> )>>;
...
/// 
/// \param stream Handle to the opened file.
typedef Dart_FileCloseCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>>;
typedef Dart_EntropySource = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>>;
...
typedef Dart_RegisterKernelBlobCallback = ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>>;
/// Optional callback provided by the embedder that is used by the VM to
...
typedef Dart_UnregisterKernelBlobCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> )>>;
...
typedef Dart_MessageNotifyCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_Isolate )>>;
...
typedef Dart_EnvironmentCallback = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>>;
...
typedef Dart_NativeEntryResolver = ffi.Pointer<ffi.NativeFunction<Dart_NativeFunction Function(ffi.Handle , ffi.Int , ffi.Pointer<ffi.Bool> )>>;
/// A native function.
typedef Dart_NativeFunction = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_NativeArguments )>>;
...
/// 
/// See Dart_SetNativeResolver.
typedef Dart_NativeEntrySymbol = ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Uint8> Function(Dart_NativeFunction )>>;
/// FFI Native C function pointer resolver callback.
/// 
/// See Dart_SetFfiNativeResolver.
typedef Dart_FfiNativeResolver = ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Char> , ffi.UintPtr )>>;
...
/// the kernel bytes.
typedef Dart_LibraryTagHandler = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Int32 , ffi.Handle , ffi.Handle )>>;
...
typedef Dart_DeferredLoadHandler = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.IntPtr )>>;
...
typedef Dart_StreamingWriteCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Uint8> , ffi.IntPtr )>>;
typedef Dart_CreateLoadingUnitCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> , ffi.IntPtr , ffi.Pointer<ffi.Pointer<ffi.Void>> , ffi.Pointer<ffi.Pointer<ffi.Void>> )>>;
typedef Dart_StreamingCloseCallback = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>>;
...
typedef Dart_NativeMessageHandler = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_Port , ffi.Pointer<Dart_CObject> )>>;
typedef Dart_PostCObject_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port_DL , ffi.Pointer<Dart_CObject> )>>;
typedef Dart_Port_DL = ffi.Int64;
typedef Dart_PostInteger_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port_DL , ffi.Int64 )>>;
typedef Dart_NewNativePort_Type = ffi.Pointer<ffi.NativeFunction<Dart_Port_DL Function(ffi.Pointer<ffi.Char> , Dart_NativeMessageHandler_DL , ffi.Bool )>>;
typedef Dart_NativeMessageHandler_DL = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_Port_DL , ffi.Pointer<Dart_CObject> )>>;
typedef Dart_CloseNativePort_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port_DL )>>;
typedef Dart_IsError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>>;
typedef Dart_IsApiError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>>;
typedef Dart_IsUnhandledExceptionError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>>;
typedef Dart_IsCompilationError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>>;
typedef Dart_IsFatalError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>>;
typedef Dart_GetError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Handle )>>;
typedef Dart_ErrorHasException_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Handle )>>;
typedef Dart_ErrorGetException_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>>;
typedef Dart_ErrorGetStackTrace_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>>;
typedef Dart_NewApiError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Char> )>>;
typedef Dart_NewCompilationError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Char> )>>;
typedef Dart_NewUnhandledExceptionError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>>;
typedef Dart_PropagateError_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Handle )>>;
typedef Dart_HandleFromPersistent_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>>;
typedef Dart_HandleFromWeakPersistent_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_WeakPersistentHandle )>>;
typedef Dart_NewPersistentHandle_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle )>>;
typedef Dart_SetPersistentHandle_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Handle , ffi.Handle )>>;
typedef Dart_DeletePersistentHandle_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Handle )>>;
typedef Dart_NewWeakPersistentHandle_Type = ffi.Pointer<ffi.NativeFunction<Dart_WeakPersistentHandle Function(ffi.Handle , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>>;
typedef Dart_DeleteWeakPersistentHandle_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_WeakPersistentHandle )>>;
typedef Dart_UpdateExternalSize_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_WeakPersistentHandle , ffi.IntPtr )>>;
typedef Dart_NewFinalizableHandle_Type = ffi.Pointer<ffi.NativeFunction<Dart_FinalizableHandle Function(ffi.Handle , ffi.Pointer<ffi.Void> , ffi.IntPtr , Dart_HandleFinalizer )>>;
typedef Dart_DeleteFinalizableHandle_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_FinalizableHandle , ffi.Handle )>>;
typedef Dart_UpdateFinalizableExternalSize_Type = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(Dart_FinalizableHandle , ffi.Handle , ffi.IntPtr )>>;
typedef Dart_Post_Type = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(Dart_Port_DL , ffi.Handle )>>;
typedef Dart_NewSendPort_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(Dart_Port_DL )>>;
typedef Dart_SendPortGetId_Type = ffi.Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Handle , ffi.Pointer<Dart_Port_DL> )>>;
...
class transport extends ffi.Struct{
  external ffi.Pointer<transport_listener_configuration_t> listener_configuration;

  external ffi.Pointer<transport_worker_configuration_t> inbound_worker_configuration;

  external ffi.Pointer<transport_worker_configuration_t> outbound_worker_configuration;
...
const String kIsolateSnapshotInstructionsCSymbol = '_kDartIsolateSnapshotInstructions';
