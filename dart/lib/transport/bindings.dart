...
class TransportBindings {
  ...
  late final _transport_channel_acceptPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<transport_channel_t>,
              ffi.Int)>>('transport_channel_accept');
  late final _transport_channel_accept = _transport_channel_acceptPtr
      .asFunction<void Function(ffi.Pointer<transport_channel_t>, int)>();

  int transport_channel_receive(
    ffi.Pointer<transport_channel_t> channel,
    int fd,
  ) {
    return _transport_channel_receive(
      channel,
      fd,
    );
  }

  late final _transport_channel_receivePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<transport_channel_t>,
              ffi.Int)>>('transport_channel_receive');
  late final _transport_channel_receive = _transport_channel_receivePtr
  ...
  late final _transport_channel_sendPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<transport_channel_t>,
              ffi.Pointer<transport_payload_t>)>>('transport_channel_send');
  late final _transport_channel_send = _transport_channel_sendPtr.asFunction<
      int Function(ffi.Pointer<transport_channel_t>,
          ffi.Pointer<transport_payload_t>)>();

  ffi.Pointer<transport_payload_t> transport_channel_allocate_write_payload(
    ffi.Pointer<transport_channel_t> channel,
    int fd,
  ) {
    return _transport_channel_allocate_write_payload(
      channel,
      fd,
    );
  }

  late final _transport_channel_allocate_write_payloadPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<transport_payload_t> Function(
              ffi.Pointer<transport_channel_t>,
              ffi.Int)>>('transport_channel_allocate_write_payload');
  late final _transport_channel_allocate_write_payload =
      _transport_channel_allocate_write_payloadPtr.asFunction<
          ffi.Pointer<transport_payload_t> Function(
              ffi.Pointer<transport_channel_t>, int)>();

  void transport_channel_free_read_payload(
    ffi.Pointer<transport_channel_t> channel,
    ffi.Pointer<transport_payload_t> payload,
  ) {
    return _transport_channel_free_read_payload(
      channel,
      payload,
    );
  }

  late final _transport_channel_free_read_payloadPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<transport_channel_t>,
                  ffi.Pointer<transport_payload_t>)>>(
      'transport_channel_free_read_payload');
  late final _transport_channel_free_read_payload =
      _transport_channel_free_read_payloadPtr.asFunction<
          void Function(ffi.Pointer<transport_channel_t>,
              ffi.Pointer<transport_payload_t>)>();

  void transport_channel_free_write_payload(
    ffi.Pointer<transport_channel_t> channel,
    ffi.Pointer<transport_payload_t> payload,
  ) {
    return _transport_channel_free_write_payload(
      channel,
      payload,
    );
  }

  late final _transport_channel_free_write_payloadPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<transport_channel_t>,
                  ffi.Pointer<transport_payload_t>)>>(
      'transport_channel_free_write_payload');
  late final _transport_channel_free_write_payload =
      _transport_channel_free_write_payloadPtr.asFunction<
          void Function(ffi.Pointer<transport_channel_t>,
              ffi.Pointer<transport_payload_t>)>();
  ...
  late final _transport_acceptor_acceptPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<transport_acceptor_t>)>>('transport_acceptor_accept');
  late final _transport_acceptor_accept = _transport_acceptor_acceptPtr
      .asFunction<int Function(ffi.Pointer<transport_acceptor_t>)>();

  int transport_acceptor_loop(
    ffi.Pointer<__va_list_tag> input,
  ) {
    return _transport_acceptor_loop(
      input,
    );
  }

  late final _transport_acceptor_loopPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<__va_list_tag>)>>(
          'transport_acceptor_loop');
  late final _transport_acceptor_loop = _transport_acceptor_loopPtr
  ...
  late final _transport_initialize_connectorPtr = _lookup<
      ffi.NativeFunction<
  ...
  void transport_close_connector(
    ...
    return _transport_close_connector(
      connector,
    );
  }

  late final _transport_close_connectorPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<transport_connector_t>)>>(
      'transport_close_connector');
  late final _transport_close_connector = _transport_close_connectorPtr
      .asFunction<void Function(ffi.Pointer<transport_connector_t>)>();

  int transport_connector_connect(
    ffi.Pointer<transport_connector_t> connector,
  ) {
    return _transport_connector_connect(
      connector,
    );
  }

  late final _transport_connector_connectPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int32 Function(ffi.Pointer<transport_connector_t>)>>(
      'transport_connector_connect');
  late final _transport_connector_connect = _transport_connector_connectPtr
      .asFunction<int Function(ffi.Pointer<transport_connector_t>)>();

  int transport_connector_loop(
    ffi.Pointer<__va_list_tag> input,
  ) {
    return _transport_connector_loop(
      input,
    );
  }

  late final _transport_connector_loopPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<__va_list_tag>)>>(
          'transport_connector_loop');
  late final _transport_connector_loop = _transport_connector_loopPtr
      .asFunction<int Function(ffi.Pointer<__va_list_tag>)>();
...
class _SymbolAddresses {
  ...
  ffi.Pointer<
          ffi.NativeFunction<
              ffi.Int32 Function(ffi.Pointer<transport_channel_t>, ffi.Int)>>
      get transport_channel_receive => _library._transport_channel_receivePtr;
  ffi.Pointer<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<transport_channel_t>,
              ffi.Pointer<transport_payload_t>)>> get transport_channel_send =>
      _library._transport_channel_sendPtr;
  ffi.Pointer<
          ffi.NativeFunction<
              ffi.Pointer<transport_payload_t> Function(
                  ffi.Pointer<transport_channel_t>, ffi.Int)>>
      get transport_channel_allocate_write_payload =>
          _library._transport_channel_allocate_write_payloadPtr;
  ffi.Pointer<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<transport_channel_t>,
                  ffi.Pointer<transport_payload_t>)>>
      get transport_channel_free_read_payload =>
          _library._transport_channel_free_read_payloadPtr;
  ffi.Pointer<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<transport_channel_t>,
                  ffi.Pointer<transport_payload_t>)>>
      get transport_channel_free_write_payload =>
          _library._transport_channel_free_write_payloadPtr;
  ffi.Pointer<
      ffi.NativeFunction<
          ffi.Pointer<transport_acceptor_t> Function(
              ffi.Pointer<transport_t>,
  ...
  ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<__va_list_tag>)>>
      get transport_acceptor_loop => _library._transport_acceptor_loopPtr;
  ffi.Pointer<
      ffi.NativeFunction<
          ffi.Pointer<transport_connector_t> Function(
              ffi.Pointer<transport_t>,
  ...
  ffi.Pointer<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<transport_connector_t>)>>
      get transport_close_connector => _library._transport_close_connectorPtr;
  ffi.Pointer<
          ffi.NativeFunction<
              ffi.Int32 Function(ffi.Pointer<transport_connector_t>)>>
      get transport_connector_connect =>
          _library._transport_connector_connectPtr;
  ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<__va_list_tag>)>>
...
class UnnamedUnion11 extends ffi.Union {
  ...
  external UnnamedStruct13 as_send_port;

  external UnnamedStruct14 as_capability;

  external UnnamedStruct15 as_array;

  external UnnamedStruct16 as_typed_data;

  external UnnamedStruct17 as_external_typed_data;

  external UnnamedStruct18 as_native_pointer;
}
...
class mslab extends ffi.Struct {
  ...
  external UnnamedStruct19 next_in_hot;
...
class __mbstate_t extends ffi.Struct {
  ...
  external UnnamedUnion12 __value;
}
...
class transport_connector_configuration extends ffi.Struct {
  @ffi.Uint32()
  external int ring_size;
}
...
class transport_connector extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.Char> client_ip;
...
typedef transport_connector_t = transport_connector;
typedef transport_connector_configuration_t = transport_connector_configuration;
