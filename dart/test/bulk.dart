...
void testBulk() {
  test("bulk", () async {
    ...
    worker.servers.tcp(InternetAddress("0.0.0.0"), 12345, (connection) => connection.read().listen((value) => serverCompleter.complete(value.takeBytes())));
    ...
    await workerFile1.read().then((value) => Validators.request(value));
    await workerFile2.read().then((value) => Validators.request(value));
    await workerFile3.read().then((value) => Validators.request(value));
