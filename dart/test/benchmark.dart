...
Future<void> main(List<String> args) async {
  ...
  serverTransport.connection(TransportDefaults.connection(), TransportDefaults.channel()).bind("0.0.0.0", 1234).listen((serverChannel) async {
  ...
  clientTransport.connection(TransportDefaults.connection(), TransportDefaults.channel()).connect("127.0.0.1", 1234).listen((clientChannel) async {
